...
грузовых  автомобилей </span><?=$in_city ?>
                            </h1>
            ...
            <div class="col-md-12 col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="product-template-bg">
                                <div title="взять кредит в залог автомобиля" class="element-img grey" style="background-image: url(images/product/gazel2.png);"></div>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="product-template-bg">
                                <div title="кредит под залог птс спецтехники москва" class="element-img grey" style="background-image: url(images/product/tyagach2.png);"></div>
                ...
                <div class="visible-on-mobile">
                    <div class="owl-carousel owl-theme product">
                        <div class="product-template-bg">
                            <div class="element-img grey" style="background-image: url(images/product/gazel2.png);"></div>
                            <div class="element-title">Газели</div>
                            <div class="element-text">грузовые, пассажирские</div>
                            <div class="element-wrap"><a href="#" class="btn btn-danger" data-toggle="modal" data-target="#specifications">Оценить</a></div>
                        </div>
                        ...
                        <div class="product-template-bg">
                            <div class="element-img grey" style="background-image: url(images/product/tyagach2.png);"></div>
                            <div class="element-title">Тягачи</div>
                            <div class="element-text">отечественные и импортные</div>
                            <div class="element-wrap"><a href="#" class="btn btn-danger" data-toggle="modal" data-target="#specifications">Оценить</a></div>
                        </div>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-12">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-6">
                        <img class="m-t-image" src="images/p4298/bluetruck.png" alt="Автоломбард под залог ПТС"/>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-11 col-sm-12">
                ...
                <div class="owl-carousel owl-theme questions-block-1">
                    <div class="question-answer">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="question"> Могу ли я возвратить долг за грузовой автомобиль раньше
                                    условленного срока?
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="answer">Мы выдаём деньги под залог грузового автомобиля на определенный
                                    срок. Но вы можете вернуть долг раньше этого срока без начисления пени.
                    ...
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">Нет, наша компания только кредитует, оставляя себе в качестве
                                    залога, ПТС грузовика. Автомобиль при этом остаётся в вашей собственности и вы
                                    можете пользоваться им, как пожелаете. После полной выплаты займа, мы вернём вам
                                    ПТС.
                    ...
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">Да, мы выдаём ПТС под залог грузовиков с определённым сроком
                                    эксплуатации. Рассматриваем отечественный автопром со сроком до 10 лет эксплуатации,
                                    импортный – до 20 лет.
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="owl-carousel owl-theme reviews-1">
                    <article class="review-bg-no">
                        <div class="review-text">Обратился в «Автоломбардини», чтобы взять кредит под залог грузового
                            автомобиля. Оформил заявку в режиме онлайн, так как не было времени ехать в офис. Деньги
                            пришли на банковскую карту в тот же день, я очень был этому рад.
                        </div>
                        <div class="review-person">
                            <div class="review-name">Валерий С.</div>
                        </div>
                    </article>
                    <article class="review-bg-no">
                        <div class="review-text">Решил посетить данный ломбард, чтобы взять деньги в залог под ПТС
                            грузового автомобиля. Сотрудник быстро всё оформил и подготовил все нужные документы. Сразу
                            же получил деньги и остался доволен.
                        </div>
                        <div class="review-person">
                    ...
                    <article class="review-bg-no">
                        <div class="review-text">Взял займ под залог грузового автомобиля и остался доволен результатом.
                            Меня не обманули и выдали деньги в течение 1 часа. В случае чего, обязательно обращусь еще
                            раз сюда, так как мне всё понравилось.
                        </div>
                        <div class="review-person">
                    ...
                    <article class="review-bg-no">
                        <div class="review-text">Решил взять займ под грузовой автомобиль в Москве. Очень хорошие
                            условия мне предложили в этом автоломбарде, поэтому я и согласился. Получается, что моя
                            машина в залоге, но по факту я ей пользуюсь, тем самым погашая задолженность.
                    ...
                    <article class="review-bg-no">
                        <div class="review-text">Обращался в несколько МФО, чтобы взять деньги под залог грузовых авто.
                            Но только в этом автоломбарде понравились условия, и устроила процентная ставка. Трейлер
                            остался при мне, и я остался очень доволен, что мне не пришлось его отдавать.
                        </div>
                        <div class="review-person">
                            <div class="review-name">Федор</div>
                        </div>
                    </article>
                </div>
            </div>
