                ...
                <div class="inner-navigation visible-on-wade">
                    <div class="inner-nav">
                        <div class="inner-block">
                            ...
                            <button type="button" class="btn btn-line-white"
                                    style="color: white; border: 1px white solid; background:    #013766"
                                    data-toggle="modal" data-target="#CallPhone-ver-2">Обратный звонок
                            </button>
