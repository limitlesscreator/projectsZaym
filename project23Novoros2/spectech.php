...
<div title="взять кредит в залог автомобиля" class="bgImageAvto">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="offer-bg-incline bg-2">
                            <div class="z-index">
                                <h1 class="h1 padding-leftOnPc3">Автоломбард под залог ПТС
                                                                 спецтехники в Новосибирске</h1>
                               ...
                               <div class="row">
                                   <div class="col-md-3 col-sm-6 col-xs-12">
                                       <div class="product-template-bg">
                                           <div title="взять кредит в залог автомобиля" class="element-img grey" style="background-image: url(images/product/tractor2.jpg);"></div>
 ...
 <div class="element-wrap"><a href="#" class="btn btn-danger" data-toggle="modal"
                                   ...
                                   <div class="col-md-3 col-sm-6 col-xs-12">
                                       <div class="product-template-bg">
                                           <div title="кредит под залог грузового автомобиля в банке" class="element-img grey" style="background-image: url(images/product/pogruzchik2.jpg);"></div>
 ...
 <div class="element-wrap"><a href="#" class="btn btn-danger" data-toggle="modal"
                                   ...
                                   <div class="col-md-3 col-sm-6 col-xs-12">
                                       <div class="product-template-bg">
                                           <div title="кредит под залог птс" class="element-img grey" style="background-image: url(images/product/buldozer2.jpg);"></div>
 ...
 <div class="element-wrap"><a href="#" class="btn btn-danger" data-toggle="modal"
                           ...
                           <div class="visible-on-mobile">
                               <div class="owl-carousel owl-theme product">
                                   <div class="product-template-bg">
                                       <div class="element-img grey" style="background-image: url(images/product/tractor2.jpg);"></div>
                                       <div class="element-title">Тракторы</div>
                                       <div class="element-text">Колесные и гусеничные</div>
                                   ...
                                   <div class="product-template-bg">
                                       <div class="element-img grey" style="background-image: url(images/product/pogruzchik2.jpg);"></div>
                                       <div class="element-title">Погрузчики</div>
                                       <div class="element-text">Вилочные ковшовые</div>
                                   ...
                                   <div class="product-template-bg">
                                       <div class="element-img grey" style="background-image: url(images/product/buldozer2.jpg);"></div>
                                       <div class="element-title">Бульдозеры</div>
                                       <div class="element-text">Гидравлические, механические</div>
                        ...
                        <div class="owl-carousel owl-theme questions-block-2">
                            <div class="question-answer">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="answer">Да, сейчас у вас уникальная возможность получить займ под залог спецтехники. В автоломбарде вы оставляете заявку, и указываете нужную сумму, технические характеристики спецтехники. Оставляете ПТС оборудования, и получаете деньги наличными или переводом на карту.
                            ...
                            <div class="question-answer">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="answer">В качестве залогового имущества в автоломбарде принимают не только транспортные средства, но и спецтехнику. Это могут быть погрузочные краны, тракторы, бульдозеры, катки и многое другое. Оформите кредит под залог ПТС спецтехники, и получите деньги в день обращения.
                            ...
                            <div class="question-answer">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="answer">Автоломбард спецтехники под залог ПТС в Новосибирске работает круглосуточно. Вы можете оставить заявку на кредит в любое удобное время – на официальном сайте. На обработку вашей анкеты нужно не более 15-20 минут. После этого вам придет СМС с ответом. Если займ будет одобрен, то вы сможете запросить нужную сумму переводом на банковскую карту.
                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="owl-carousel owl-theme reviews-2" style="color: white">
                                <article class="review-bg-blue" >
                                    <div class="review-text" >Недавно узнал, что можно выгодно оформить займ под залог ПТС спецтехники в Новосибирске. У меня собственный бизнес, который периодически требует вложений, но денег регулярно не хватает. Обращаюсь теперь только в эту компанию, ведь здесь есть возможность досрочного погашения, что позволяет экономить средства.
                                ...
                                <article class="review-bg-blue" >
                                    <div class="review-text" >Оформлял займ под спецтехнику в этой компании. Нужно минимум документов и времени. Это реально профессионалы, работающие быстро и без лишних вопросов. Выкупить ПТС потом можно досрочно. Их работой остался доволен на все 100%.
                                ...
                                <article class="review-bg-blue" >
                                    <div class="review-text" >В этом автоломбарде залог под ПТС спецтехники максимально выгодный — в этом убедился сам. Оформлял под залог два автокрана — быстро и реально оценили, выплатили деньги сразу. Заключается договор, поэтому можно не переживать, что обманут. Теперь даже друзьям рекомендую эту компанию, так как в их компетентности убедился сам.
                ...
                <div class="row">
                    <div class="col-md-5 col-sm-12">
                        <div class="bg-grey-man">
                            ...
                            <img src="images/product/tracktor11.png" style="transform: scaleX(-1);"
                                 alt="Автоломбард под залог ПТС  в Новосибирске"/>
                        </div>
                    </div>
