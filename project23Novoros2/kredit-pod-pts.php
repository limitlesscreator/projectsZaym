                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="offer-bg-incline bg-2">
                            <div class="z-index">
                                <h1 class="h1 padding-leftOnPc3"><span class="h1-span">Кредит под залог ПТС
                                                                                       авто в Новосибирске</h1>
                    ...
                    <div class="col-md-11 col-sm-12">
                        ...
                        <div class="owl-carousel owl-theme questions-block-2">
                            <div class="question-answer">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="question">На какой срок выдают кредит под залог автомобиля для юридических лиц?
</div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="answer">Как и при кредитовании физических лиц, коммерческие организации могут рассчитывать на оформление займа под залог машины сроком 1-5 лет. Вы получаете кредит под залог машины, не лишаясь ее, а оставляя в автоломбарде ПТС и другие документы.
                            ...
                            <div class="question-answer">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="question">Учитывается ли кредитная история при получении займа под залог ПТС для юр. лиц и ИП?
</div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="answer">Чтобы получить кредит под залог ПТС в автоломбарде, вам нужно лишь оставить заявку на сайте и предоставить документы на транспортное средство или спецтехнику. Кредитная история юр. лиц и ИП нас не интересует.
                            ...
                            <div class="question-answer">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="question">Каковы ваши требования к транспортному средству для получения кредита юр. лицам?  </div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="answer">Чтобы взять кредит под залог машины в Новосибирске, нужно проверить исправность транспортного средство. Вам будет одобрен займ, если авто в исправном состоянии и срок эксплуатации не превышает 10 лет (для отечественных ТС) и 20 лет (для импортных ТС).
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="owl-carousel owl-theme reviews-2" style="color: white">
                                <article class="review-bg-blue" >
                                    <div class="review-text" >Не мог оформить кредит в банке, так как плохая история. Попробовал оформить кредит под залог ПТС машины в этой компании — все получилось. Никаких лишних вопросов, все четко и по делу. Быстро оценили, перечислили деньги, я на все 100% доволен, даже не ожидал, что все получится. Вариант лучший, это я понял на собственном опыте.
                                ...
                                <article class="review-bg-blue" >
                                    <div class="review-text" >Хотел взять кредит под залог авто в Новосибирске. Сразу обратился в эту компанию, так как здесь много положительных отзывов. Тоже остался доволен, так как работают быстро и деньги можно получить уже в день обращения. Для оформления понадобился паспорт и документы на транспортное средство. Оценку провели быстро, выплатили деньги сразу после заключения договора. Ребята настоящие молодцы!
                                ...
                                <article class="review-bg-blue" >
                                    <div class="review-text" >Искал где взять кредит наличными под залог ПТС авто. Друзья порекомендовали этот автоломбард. Обратился, думал откажут, так как машина далеко не в идеальном состоянии. Все одобрили, оценили по реальной стоимости. Деньги выдали наличными сразу после подписания договора. Выплатил быстро и очень доволен сотрудничеством, при необходимости буду снова обращаться.
