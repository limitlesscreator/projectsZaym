...
<div title="взять кредит в залог автомобиля" class="bgImageAvto">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="offer-bg-incline bg-2">
                            <div class="z-index">
                                <h1 class="h1 padding-leftOnPc3"><span class="h1-span">Автоломбард под залог ПТС
                                                                                       мототехники в
                                    Новосибирске</h1>
                              ...
                              <div class="row">
                                  <div class="col-md-3 col-sm-6 col-xs-12">
                                      <div class="product-template-bg">
                                          <div title="взять кредит в залог мотоцикла  в Новороссийске" class="element-img grey" style="   background-image: url(images/product/motorbike5.jpg);background-position-y: -21px;"></div>
 ...
 <div class="element-wrap"><a href="#" class="btn btn-danger" data-toggle="modal"
                                  ...
                                  <div class="col-md-3 col-sm-6 col-xs-12">
                                      <div class="product-template-bg">
                                          <div title="кредит под залог грузового мотороллера  в Новороссийске" class="element-img grey" style="    background-size: contain;background-image: url(images/product/skuter.jpg);"></div>
 ...
 <div class="element-wrap"><a href="#" class="btn btn-danger" data-toggle="modal"
                                  ...
                                  <div class="col-md-3 col-sm-6 col-xs-12">
                                      <div class="product-template-bg">
                                          <div title="кредит под залог птс чоппера  в Новороссийске" class="element-img grey" style="    background-size: contain;background-image: url(images/product/chooper1.jpg);"></div>
 ...
 <div class="element-wrap"><a href="#" class="btn btn-danger" data-toggle="modal"
                                  ...
                                  <div class="col-md-3 col-sm-6 col-xs-12">
                                      <div class="product-template-bg">
                                          <div title="кредит под залог мопеда  в Новороссийске" class="element-img grey" style="    background-size: contain;background-image: url(images/product/motorbike4.jpg); background-position-y: 0px;"></div>
 ...
 <div class="element-wrap"><a href="#" class="btn btn-danger" data-toggle="modal"
                          ...
                          <div class="visible-on-mobile">
                              <div class="owl-carousel owl-theme product">
                                  <div class="product-template-bg">
                                      <div class="element-img grey" style=" background-image: url(images/product/motorbike5.jpg);background-position-y: -21px;"></div>
                                      <div class="element-title">Мотоцикл</div>
                    ...
                    <div class="col-md-11 col-sm-12">
                        ...
                        <div class="owl-carousel owl-theme questions-block-2">
                            <div class="question-answer">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="question">Могу ли я вернуть деньги за свой мотоцикл раньше установленного срока?
</div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="answer">Вам доступен кредит под залог ПТС мотоцикла в Новосибирске. Автоломбард предлагает лучшие условия кредитования, в том числе возможность досрочного погашения займа. И обратите внимание, без начисления пени.
                            ...
                            <div class="question-answer">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="question"> Можете ли вы переоформить мой мотоцикл на ваш автоломбард?
</div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="answer">Когда вы берете кредит под залог ПТС мотоцикла, то транспортное средство остается у вас. Автоломбард получает только паспорт и другие документы на движимое имущество. То есть компания – лишь кредитует физических и юридических лиц.
                            ...
                            <div class="question-answer">
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="question">На какой срок можно получить займ под залог мототехники?
</div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="answer">В большинстве случаев займ под залог ПТС мотоцикла оформляется на срок от 1 до 5 лет. При этом каждый клиент может рассчитывать на досрочное погашение займа, без начисления пени за прошлые периоды.
                        ...
                        <div class="col-md-12 col-sm-12">
                            ...
                            <div class="owl-carousel owl-theme reviews-2" style="color: white">
                                <article class="review-bg-blue" >
                                    <div class="review-text" >Брал займ под залог ПТС мотоцикла в Новосибирске в этом автоломбарде. Сначала привлекла низкая процентная ставка. Потом понравилось то, что здесь оценивают по рыночной стоимости, ничего не занижают. Сотрудники вежливые, заинтересованные в каждом клиенте. Если понадобятся деньги под залог, теперь я знаю куда обратиться.
                                    </div>
                                    <div class="review-person">
                                        <div class="review-name">Рамзан</div>
                                    </div>
                                </article>
                                <article class="review-bg-blue" >
                                    <div class="review-text" >Хотел оформить кредит под залог ПТС мотоцикла, но отказывали во всех автоломбардах. Друг посоветовал эту компанию — я обратился и не пожалел. Реально выгодные условия, низкий процент, минимум переплат. Оформили быстро — нужен только паспорт и ПТС. Остался доволен, осталось совсем немного и выкуплю документы.

                                    </div>
                                    <div class="review-person">
                                        <div class="review-name">Ираклий</div>
                                    </div>
                                </article>
                                <article class="review-bg-blue" >
                                    <div class="review-text" >Оформлял займ под залог ПТС мотоцикла в этой компании уже несколько раз. Всегда доволен результатом, ведь работают быстро и профессионально. Нравится то, что обратиться можно круглосуточно, никогда не откажут. Деньги переводят быстро, без задержек. Доволен, спасибо.
                ...
                <div class="row">
                    <div class="col-md-5 col-sm-12">
                        <div class="bg-grey-man">
                            ...
                            <img src="images/product/mot1.png" style="transform: scaleX(-1);"
                                 alt="Автоломбард под залог ПТС  в Новосибирске"/>
                        </div>
                    </div>
                        ...
                        <div class="thank-answer-block">
                            ...
                            <div class="thank-answer">
                                <div class="thank-answer-img"><img src="images/icon/project23/dollar.png"
                                                                   alt="Автоломбард под залог ПТС  в Новосибирске"/></div>
