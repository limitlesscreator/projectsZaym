                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="offer-bg-incline bg-2">
                            <div class="z-index">
                                <h1 class="h1 padding-leftOnPc3"><span class="h1-span">Автоломбард под залог ПТС  для Юр. Лиц. в Новосибирске</h1>
                        ...
                        <div class="owl-carousel owl-theme questions-block-2">
                            <div class="question-answer">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="answer">Сейчас автоломбарды выдают займы под залог ПТС для юридических лиц при наличие генеральной доверенности на транспортное средство. То есть вам не обязательно быть собственником ТС, достаточно полной доверенности и паспорта на авто.
                            ...
                            <div class="question-answer">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="answer">Если вы боитесь получить отказ в оформлении кредита юр. лицам под залог автомобиля, то знайте, что это маловероятно. Вам нужно лишь оставить заявку на сайте, предоставить все документы на авто (ПТС, СТС, генеральная доверенность, паспорт гражданина РФ).
                            ...
                            <div class="question-answer">
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        <div class="answer">Автоломбард предлагает оформление кредита юр. лицам под залог автомобиля на срок от 1 до 5 лет. У вас также есть возможность досрочного погашения без уплаты пени.
