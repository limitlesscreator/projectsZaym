            ...
            <div class="row">
                <div class="col-md-11 col-sm-12">
                    ...
                    <div class="row m-b-30">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <h2>Требования к юр. лицам и автомобилю</h2>
                            <ul class="list-ul">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <article class="review-bg-grey">
                                    <div class="review-text">Моя компания влезла в небольшие долги, поэтому я заинтересовался кредитом под залог авто. Автоломбард под залог ПТС для юр. лиц в Московской области действительно выручил меня. Оформлял кредит на три автомобиля, все прошло быстро. Компания дает все необходимые гарантии, а автомобилями можно пользоваться — это являлось приоритетом для меня. Условия более чем выгодные, сроки гибкие. Спасибо</div>
                            ...
                            <div class="col-md-4">
                                <article class="review-bg-grey">
                                    <div class="review-text">Недавно в Мытищах пришлось заложить машину в автоломбард. Компанию искал долго, ведь далеко не везде можно найти выгодные условия для юридических лиц. В этом автоломбарде сразу проконсультировали по всем вопросам, провели быструю оценку автомобиля. Выгодные условия и низкая процентная ставка — вот что привлекло меня именно в этой компании. Сотрудничеством остался доволен, кредит уже полностью погасил, нареканий никаких нет.</div>
                                    <div class="review-person">
                                        <div class="review-name">Аркадий</div>
                                    </div>
                                </article>
                            ...
                            <div class="col-md-4">
                                                               <article class="review-bg-grey">
                                                                   <div class="review-text">Нет ничего хуже долгов и необходимости срочного поиска денег. Уже несколько раз подряд меня выручал именно этот автоломбард и я очень им благодарна. Круглосуточный автоломбард в Подольске для юр. лиц предлагает клиентам выгодные условия и гибкие сроки. Обращаясь сюда, я уверена на все 100%, что мне здесь помогут — оформят сделку быстро и в любое время суток. Сотрудники всегда обходительные, ответят на все вопросы, проконсультируют. Я знаю, что в трудной ситуации я могу сюда обратиться, ведь именно для юридических лиц здесь самые приемлемые условия.</div>
                                                                   <div class="review-person">
                                                                       <div class="review-name">Анна П.</div>
                                                                   </div>
                                                               </article>
...
Недавно в Мытищах пришлось заложить машину в автоломбард. Компанию искал долго, ведь далеко не везде можно найти выгодные условия для юридических лиц. В этом автоломбарде сразу проконсультировали по всем вопросам, провели быструю оценку автомобиля. Выгодные условия и низкая процентная ставка — вот что привлекло меня именно в этой компании. Сотрудничеством остался доволен, кредит уже полностью погасил, нареканий никаких нет.</div>
                                                               <div class="review-person">
                                                                   <div class="review-name">Аркадий</div>
                                                               </div>
                                                           </article>
    ...
    <script type="text/babel">
        let data = [
            [{question: 'На какой срок выдают кредит под залог авто для юридических лиц и ИП?'},
                {answer: 'Вас интересуют выгодные займы под залог ПТС ТС юридическим лицам? Обратитесь в нашу компанию! Мы предоставляем денежные ссуды организациям и ИП. Срок выдачи займа составляет 1-5 лет. Лимиты зависят от рыночной стоимости автомобиля или спецтехники (в зависимости от типа объекта).'},
                {numId: '0'},
                {numIdText: 'Zero'}],

            [{question: 'Учитывается ли кредитная история при получении займа под залог ПТС для юр. лиц?'},
                {answer: 'Кредитная история не имеет значения. Мы выдаём займы под залог ПТС авто юр. лицам, независимо от их опыта сотрудничества с банками и другими кредиторами. История взаимодействия заемщика с другими кредитными организациями не рассматривается и никак не проверяется.'},
                {numId: '1'},
                {numIdText: 'One'}],

            [{question: 'Какие требования к авто для получения займа юр. лицам?'},
                {answer: 'Транспортное средство должно находиться в исправном состоянии. Мы принимаем отечественные автомобили  до 10 лет выпуска, и зарубежные авто – до 20 лет выпуска. Обратитесь к нам – доверьте решение всех вопросов профессионалам, которые выдают деньги под залог ПТС юр. лицам уже много лет.
'},
                {numId: '2'},
                {numIdText: 'Two'}],
