...
<head>
    ...
    <title>Автоломбард под залог ПТС в Самаре</title>
    <meta name="description" content="Автоломбард под залог ПТС   в Самаре"/>
...
<div title="взять кредит в залог автомобиля в Самаре" class="bgImageAvto">
                    ...
                    <div class="col-md-6">
                        <div style="padding-left: 20px" class="content-on-figure">
                            <h1 class="h1" style="margin-left: 50px;text-align: left;"><span style="text-align: left"
                                                                                             class="h1-span"> Займ под залог
 ПТС
  </span><span class="yellow-text"> в Самаре</span></h1>
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6 product-template">
                            <div class="element relative" title="займ под птс авто">
                                <div class="element-img"
                                     style="background-image: url(images/product/sedan3.png);"></div>
                                    ...
                                    <div class="element-content">
                                        ...
                                        <div class="element-wrap">
                                            <button type="submit" class="btn btn-danger" data-toggle="modal"
                                                    data-target="#specifications">Оценить
                                            </button>
                        ...
                        <div class="col-md-3 col-sm-6 product-template">
                            <div class="element relative" title="займ под залог грузового автомобиля">
                                <div class="element-img"
                                     style="background-image: url(images/product/truck3.png);"></div>
                                <div class="element-content-wrapper">
                                    <div class="element-content">
                        ...
                        <div class="col-md-3 col-sm-6 product-template">
                            <div class="element relative" title="займ под залог птс мотоцикла">
                                <div class="element-img"
                                     style="background-image: url(images/product/motorbike3.png);"></div>
                                <div class="element-content-wrapper">
                                    <div class="element-content">
...
<section id="advantages-3">
    <div class="container">
        <div class="row">
            <div class="col-md-11">
                <h3 class="h1"><span class="h1-span">Лучшее обслуживание </span><span class="yellow-text">для каждого клиента</span></h3>
                ...
                <div class="visible-on-wade visible-on-tablet">
                    <div class="row">
                        ...
                        <div class="col-md-2 col-sm-3">
                            <div class="list-icon-grey-item">
                                <div class="list-icon-grey-item-img"
                                     style="background-image: url(images/icon/p4298/Car_main.png); background-size: 50px 50px;"></div>
            ...
            <div class="col-md-4 col-sm-12">
                <div class="row">
                    <div class="col-md-12 col-sm-6">
                        <h3 class="h1 m-t-image"><span class="h1-span"><span class="h1-span">Получение займа
    </span></span> <span class="yellow-text">под залог ПТС</span></h3>
                    </div>
                    <div class="col-md-12 col-sm-6">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12">
                    <div class="interlayer-office-content">
                        ...
                        <p class="m-b-30">Оставьте свои контактные данные, получите одобрение и приезжайте к нам на
                            подписание документов и получение денежных средств</p>

                        <form class="overlay-header-form row" method="post"
                              onsubmit="ym(44354128, 'reachGoal', 'calculate'); gtag('event', 'onlajn-zayavka', {'event_category': 'form', 'event_action': 'calculate'}); return true;">
                            ...
                            <div class="form-group col-md-6 col-sm-6">
                                <input type="text" class="form-control" required id="name-a" name="name"
                                       placeholder="Как к Вам обращаться">
                            </div>
                            <div class="form-group col-md-6 col-sm-6">
                                <input type="text" class="form-control" required id="request-phone-c" name="phone"
                                       placeholder="+7 (ХХХ) ХХХ - ХХ - ХХ">
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="personal">Нажимая на кнопку, вы даёте своё согласие на обработку ваших <a
                                        target="_blank" href="#">персональных данных</a></div>
                            </div>
                        </form>
                    </div>
                </div>
...
<section id="example-loan-1">
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <h3 class="h1"><span class="h1-span">Примеры выданных </span><span class="yellow-text">займов</span></h3>
...
<section id="repay-a-loan-2">
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <h3 class="h1"><span style="color: #013766">Погашение</span> <span class="yellow-text">автозайма</span></h3>
                <div class="row">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-11 col-sm-12">
                <h3 class="h1"><span class="h1-span">Ответы на часто </span><span class="yellow-text">задаваемые вопросы</span></h3>

                <div class="owl-carousel owl-theme questions-block-2">
                    <div class="question-answer">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="question">Можно погасить займ, находясь в другом городе?
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="answer">Сейчас очень удобно проводить платежи или досрочно выплачивать займ онлайн на официальном сайте. Взять займ под залог ПТС онлайн также можно. И вы получите деньги на банковскую карту или наличными в офисе компании.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="question">Могу ли я получить одобрение займа, не приезжая в офис?
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="answer">Когда ваша заявка на кредит будет одобрена (ее можно подать онлайн), то вы можете получить деньги на свою банковскую карту. Обратите внимание, что вся процедура занимает до часа, и вам даже не нужно выходить из дома. Займ под залог ПТС без выходных, круглосуточно и онлайн!
                    ...
                    <div class="question-answer">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="question">Я купил автомобиль, но пока не оформил его в ГИБДД. Ваш ломбард выдает займы без регистрации транспортного средства?
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="answer">Получите займ под ПТС на карту прямо сейчас, оставив заявку на сайте автоломбарда. Вам нужно указать желаемую сумму, срок погашения, паспортные данные и данные об автомобиле или спецтехнике. Автоломбард выдает деньги по ДКП и по генеральной доверенности. А значит, даже если вы еще не оформили машину в ГИБДД, вы можете получить деньги на карту.
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="owl-carousel owl-theme reviews-2 whiteColor">
                        <article class="review-bg-blue">
                            <div class="review-text">Очень рекомендую этот автоломбард! Тут можно получить займ под залог ПТС в Самаре круглосуточно и без лишней бюрократии. Ставки тоже нормальные, по-другому бывает лишь в мышеловке. И авто не забирают.
                        ...
                        <article class="review-bg-blue">
                            <div class="review-text">Мне понравилось, что здесь выдают займы онлайн, под залог ПТС и на карту. Можно не выходить из дома, и просто отправить заявку. Я так и сделала, мне перезвонили, и деньги выдали уже на следующий день.
                        ...
                        <article class="review-bg-blue">
                            <div class="review-text">Тот, кто придумал автозайм под ПТС просто молодец. В общем прошло всё как по маслу, и проценты не особо большие назначили.
                        ...
                        <article class="review-bg-blue">
                            <div class="review-text">Взять займ под залог ПТС мне посоветовал мой молодой человек. Он посмотрел условия в этом автоломбарде, и сказал, что это приемлемо. Я очень обрадовалась, и сумма оценки меня также устроила, так что не жалею.
                        ...
                        <article class="review-bg-blue">
                            <div class="review-text">Когда понадобился быстрый займ под залог ПТС, о других местах не думал – мужики с работы уже брали тут деньги. Их никто не кинул, скрытых комиссий нет. Сумма по оценке ниже рыночной процентов на 30.

                            </div>
                            <div class="review-person">
                                <div class="review-name">Василий А.
                                </div>
                            </div>
                        </article>
...
<section id="section-map">
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <h3 class="h1 " style="color:#013766 ">Адреса и <span class="yellow-text">контакты</span></h3>
                ...
                <div id="map" class="ofices visible-on-wade visible-on-tablet" itemscope
                    ...
                    <script>
                        setTimeout(() => {
                            document.querySelector('#Самара').click()
                        }, 2000)
                    </script>
                </div>
...
<footer id="footer-3">
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                <div class="footer-phone m-b-30"><a href="tel:+00000000000">0(000) 000-00-00</a><br>
                    <br>
            ...
            <div class="col-md-7">
                <div class="row">
                    <div class="col-md-12">
                        <div class="footer-logo inline m-b-30"><a href="#"><img style="width: 100px"
                                                                                src="images/logoKredit.png"
                                                                                alt="Автоломбард под залог ПТС  в Новороссийске"/></a>
                        </div>
            ...
            <div class="col-md-12">
                <div class="footer-bottom">
                    <p>«Автозайм Самара» не является финансовым учреждением, банком или МФО. Сайт предоставляет
...
<div class="off-canvas-sidebar grey">
    <div class="off-canvas-sidebar-wrapper visible-on-tablet visible-on-wade">
        ...
        <div class="off-canvas-header"><a class="off-canvas-close" href="#"><img src="images/close-white.svg"
                                                                                 alt="Автоломбард под залог ПТС  в Самаре"></a>
        </div>
