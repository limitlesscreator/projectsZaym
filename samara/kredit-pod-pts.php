                    ...
                    <div class="col-md-6">
                        <div style="padding-left: 20px" class="content-on-figure">
                            <h1 class="h1" style="margin-left: 50px;text-align: left;"><span style="text-align: left"
                                                                                             class="h1-span"> Кредит под залог ПТС
            ...
            <div class="col-md-4 col-sm-12">
                <div class="row">
                    <div class="col-md-12 col-sm-6">
                        <h3 class="h1 m-t-image"><span class="h1-span"><span class="h1-span">Получение кредита
                ...
                <div class="owl-carousel owl-theme questions-block-2">
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">В автоломбарде вы можете получить кредит под залог машины, не лишаясь ее. При этом срок займа составляет от 1 до 5 лет. Есть возможность досрочного погашения, а также снижения ставки при соблюдении всех требований по договору.
                    ...
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    Чтобы получить кредит под залог ПТС личного авто, мотоцикла или спецтехники, вам не нужна «красивая» кредитная история. Автоломбард не требует подтверждения заработка, официального трудоустройства и так далее.
                    ...
                    <div class="question-answer">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="question">Каковы ваши требования к транспортному средству для получения кредита юр. лицам?
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="answer">Взять кредит под залог машины можно в том случае, если транспортное средство полностью исправно, и ремонт не требуется. Автоломбард принимает отечественное авто до 10 лет в эксплуатации, и импортные машины до 20 лет в эксплуатации.
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="owl-carousel owl-theme reviews-2 whiteColor">
                        <article class="review-bg-blue">
                            <div class="review-text">Мои заявки везде отклоняли, начал думать, что ничего не получится. А здесь дали кредит в залог ПТС машины. Причем на ней можно продолжать ездить, никто ее не забирает, как и сам ПТС. Огромное спасибо!
                            </div>
                        ...
                        <article class="review-bg-blue">
                            <div class="review-text">Я попала в странную ситуацию – машина у меня не дешевая, под миллион, а денег на мою потребность не оказалось. Друг сказал взять кредит под залог авто, и я пришла сюда. Оценили и выдали деньги за день!
                            </div>
                            <div class="review-person">
                                <div class="review-name">Алиса</div>
                            </div>
                        </article>
                        <article class="review-bg-blue">
                            <div class="review-text">Накопились налоги, нужно было платить, а денег на руках не было. Здесь мне выдали кредит наличными под залог ПТС авто, и я сразу закрыл свои долги. Теперь можно спокойно работать и отдавать этот займ.
                            </div>
                            <div class="review-person">
