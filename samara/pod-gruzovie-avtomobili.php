                    ...
                    <div class="col-md-6">
                        <div style="padding-left: 20px" class="content-on-figure">
                            <h1 class="h1" style="margin-left: 50px;text-align: left;"><span style="text-align: left"
                                                                                             class="h1-span"> Автоломбард грузовиков

  </span><span class="yellow-text">под ПТС в Самаре</span></h1>
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="visible-on-wade visible-on-tablet">
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-6 product-template">
                            <div class="element relative">
                                <div class="element-img" style="background-image: url(images/product/truck.png);"></div>
                                <div class="element-content-wrapper">
                                    <div class="element-content">
                ...
                <div class="visible-on-mobile">
                    <div class="owl-carousel owl-theme product">
                        <div class="product-template">
                            <div class="element relative " title="займ под залог птс грузового автомобиля">
                                <div class="element-img" style="background-image: url(images/product/gazel.png);"></div>
                                <div class="element-content-wrapper">
                                    <div class="element-content">
                                        <div class="element-title">Газели</div>
                        ...
                        <div class="product-template">
                            <div class="element relative" title="займ под залог грузового птс">
                                <div class="element-img" style="background-image: url(images/product/truck.png);"></div>
                                <div class="element-content-wrapper">
                                    <div class="element-content">
                                        <div class="element-title">Грузовые авто</div>
                        ...
                        <div class="product-template">
                            <div class="element relative" title="займ под птс грузовика">
                                <div class="element-img" style="background-image: url(images/product/tyagach.png);"></div>
                        ...
                        <div class="product-template">
                            <div class="element relative" title="займ под птс москва грузовик">
                                <div class="element-img" style="background-image: url(images/product/pricep.png);"></div>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-12">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-6">
                        <img class="m-t-image" src="images/product/bluetruck.png" alt="Автоломбард под залог ПТС"/>
                    </div>
                </div>
            </div>
                ...
                <div class="owl-carousel owl-theme example-loan">
                    <div class="example-car left">
                        ...
                        <div class="example-car-img"
                             style="background-image: url(images/product/whiterruck.png);    background-size: 320px; right: 86px"></div>
                    </div>
                ...
                <div class="owl-carousel owl-theme questions-block-2">
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">Сейчас в автоломбарде доступно досрочное погашение кредита. Таким образом, вы можете вернуть долг за грузовое авто быстро и без уплаты пени. Условия получения денег под залог грузового автомобиля одни из лучших среди банков и микрофинансовых организаций.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">Если вы обращаетесь в автоломбард, то компания не становится владельцем транспортного средства или спецтехники. Залог ПТС грузчика предполагает, что автоломбард лишь кредитует вас, а не переоформляет имущество на себя.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">Наша компания принимает разные транспортные средства для кредитования. Однако обратите внимание, что лучшие условия доступны для отечественных авто до 10 лет эксплуатации, а для импортных – до 20. Залог ПТС грузовика также возможен при соблюдении этих требований.
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="owl-carousel owl-theme reviews-2 whiteColor">
                        <article class="review-bg-blue">
                            <div class="review-text">Срочно нужны были деньги, банк кредит не оформлял. Узнал, что здесь дают деньги под залог ПТС грузового автомобиля, даже не поверил сначала: кому нужна рабочая техника? Но авто оценили и сумму выдали.
                        ...
                        <article class="review-bg-blue">
                            <div class="review-text">Не знал, где взять крупную сумму, и закладывать было нечего. Пока не узнал о ломбарде, где берут залог под ПТС грузового автомобиля. Причем машина остается у тебя, можно продолжать работать! Спасение!
                        ...
                        <article class="review-bg-blue">
                            <div class="review-text">Очень доволен компанией. Деньги под залог грузовых авто – это мощно. И так времена не простые, люди вертятся как могут, а тут настоящая помощь, и саму машинку не забирают.
