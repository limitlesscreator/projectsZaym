                    ...
                    <div class="col-md-6">
                        <div style="padding-left: 20px" class="content-on-figure">
                            <h1 class="h1" style="margin-left: 50px;text-align: left;"><span style="text-align: left"
                                                                                             class="h1-span"> Автоломбард спецтехники
                    ...
                    <div class="row">
                        <div class="col-md-3 col-sm-6 product-template">
                            <div class="element relative" title="быстрый займ под залог спецтехники">
                                <div class="element-img" style="background-image: url(images/product/tractor.png);"></div>
                        ...
                        <div class="col-md-3 col-sm-6 product-template">
                            <div class="element relative" title="займ под залог спецтехники">
                        ...
                        <div class="col-md-3 col-sm-6 product-template">
                            <div class="element relative" title="займ под залог птс спецтехники">
                                <div class="element-img" style="background-image: url(images/product/kran.png);"></div>
                        ...
                        <div class="col-md-3 col-sm-6 product-template">
                            <div class="element relative" title="займ под залог спецтехники москва">
                ...
                <div class="owl-carousel owl-theme example-loan">
                    <div class="example-car left">
                        ...
                        <div class="example-car-img"
                             style="background-image: url(images/product/tracktor3.png); background-size: 476px;"></div>
                    </div>
                ...
                <div class="owl-carousel owl-theme questions-block-2">
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">Мы давно занимаемся выдачей займов под залог ПТС автомобилей, разных транспортных средств, а также спецтехники. Займ под залог спецтехники очень часто используется, когда нужно большая сумма денежных средств в короткие сроки.
                    ...
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">В качестве залогового имущества мы принимаем не только личные авто, но и различную спецтехнику. Это могут быть трактора, катки, бульдозеры, погрузчики, краны и многое другое. Кредит под залог ПТС спецтехники выдается под приятный процент, с возможностью досрочного погашения.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">Автоломбард спецтехники под залог ПТС в Самаре дает возможность получить деньги в течение 30-45 минут после оформления заявки (переводом на банковскую карту). Вы также можете взять займ в офисе, который работает круглосуточно 24/7.
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="owl-carousel owl-theme reviews-2 whiteColor">
                        <article class="review-bg-blue">
                            <div class="review-text">Решил взять займ под залог ПТС спецтехники в Самаре, выбирал разные места, тут была самая дешевая ставка. Переплачивать никому не хочется, так что оформлял здесь. Пока все устраивает, никакого обмана.
                        ...
                        <article class="review-bg-blue">
                            <div class="review-text">У меня своя компания, а сейчас кризис, и поэтому постоянно приходится занимать деньги. Настоящее мое спасение в том, что здесь можно получить займ под спецтехнику, да еще и продолжить ей пользоваться!
                        ...
                        <article class="review-bg-blue">
                            <div class="review-text">Я выбрал эту контору потому, что здесь есть залог спецтехники под ПТС. Как еще можно взять кредит и не навредить своему бизнесу? Техника продолжает работать, деньги в деле. Удобно, проверено уже не раз.
