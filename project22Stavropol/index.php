...
<head>
    ...
    <title>Автоломбард под залог ПТС в Ставрополе</title>
    <meta name="description" content="Автоломбард под залог ПТС   в Ставрополе"/>
...
<div title="взять кредит в залог автомобиля в Ставрополе" class="bgImageAvto">
  ...
  </span><span class="yellow-text"> в Ставрополе</span></h1>
            ...
            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="element-img"
                                             style="background-image: url(images/product/sedan3.jpg);"></div>
                                    </div>
                                    <div class="col-md-6">
                ...
                <div class="visible-on-mobile">
                    <div class="owl-carousel owl-theme product">
                        <div class="product-template-bg grey">
                            <div class="element-img" style="background-image: url(images/product/sedan3.jpg);"></div>
                            <div class="product-right">
                                <div class="element-title">Легковые авто</div>
                                <div class="element-text">Отечественные авто, иномарки</div>
                                <div class="element-wrap"><a href="#specifications" class="btn btn-danger">Оценить
                                    ТС</a></div>
                            </div>
                        </div>
                        <div class="product-template-bg grey">
...
<section id="interlayer-2">
    <div class="container">
            ...
            <div class="col-xl-9 col-md-9 push-xl-2">
                <div class="visible-on-wade visible-on-tablet">
                    <div class="row">
                        <div class="col-md-3 col-sm-3">
                            <div class="list-icon-grey-item">
                                <div class="list-icon-grey-item-img"
                                     style="background-image: url(images/icon/like2.png);background-size: 65px;"></div>
                        ...
                        <div class="col-md-3 col-sm-3">
                            <div class="list-icon-grey-item">
                                <div class="list-icon-grey-item-img"
                                     style="background-image: url(images/icon/list2.png);background-size: 65px;"></div>
                        ...
                        <div class="col-md-3 col-sm-3">
                            <div class="list-icon-grey-item">
                                <div class="list-icon-grey-item-img"
                                     style="background-image: url(images/icon/smile2.png);background-size: 65px;"></div>
                        ...
                        <div class="col-md-3 col-sm-3">
                            <div class="list-icon-grey-item">
                                <div class="list-icon-grey-item-img"
                                     style="background-image: url(images/icon/car-insurance2.png);background-size: 65px;"></div>
                        ...
                        <div class="col-md-3 col-sm-3">
                            <div class="list-icon-grey-item">
                                <div class="list-icon-grey-item-img"
                                     style="background-image: url(images/icon/sedan2.png);background-size: 65px;"></div>
                        ...
                        <div class="col-md-3 col-sm-3">
                            <div class="list-icon-grey-item">
                                <div class="list-icon-grey-item-img"
                                     style="background-image: url(images/icon/cheque.png);background-size: 65px;"></div>
                ...
                <div class="visible-on-mobile">
                    <div class="owl-carousel owl-theme advantages-2">
                        <div class="list-icon-grey-item">
                            <div class="list-icon-grey-item-img"
                                 style="background-image: url(images/icon/icon_31.svg)"></div>
                            <div class="list-icon-grey-item-title mini">Не важна кредитная история</div>
                        </div>
                        <div class="list-icon-grey-item">
                            <div class="list-icon-grey-item-img"
                                 style="background-image: url(images/icon/icon_32.svg)"></div>
                            <div class="list-icon-grey-item-title mini">Не нужны справки</div>
                        </div>
                        <div class="list-icon-grey-item">
                            <div class="list-icon-grey-item-img"
                                 style="background-image: url(images/icon/icon_33.svg)"></div>
                            <div class="list-icon-grey-item-title mini">Не нужны поручители</div>
                        </div>
                        <div class="list-icon-grey-item">
                            <div class="list-icon-grey-item-img"
                                 style="background-image: url(images/icon/icon_34.svg)"></div>
                            <div class="list-icon-grey-item-title mini">Не требуется страхование залога</div>
                        </div>
                        <div class="list-icon-grey-item">
                            <div class="list-icon-grey-item-img"
                                 style="background-image: url(images/icon/icon_35.svg)"></div>
                            <div class="list-icon-grey-item-title mini">Авто остается у Вас</div>
                        </div>
                        <div class="list-icon-grey-item">
                            <div class="list-icon-grey-item-img"
                                 style="background-image: url(images/icon/icon_36.svg)"></div>
                            <div class="list-icon-grey-item-title mini">Нет скрытых платежей</div>
                        </div>
                    </div>
                </div>
        ...
        <figure class="get-image-interlayer visible-on-wade visible-on-tablet"><img src="images/subaru2.png"
                                                                                    alt="subaru"
                                                                                    style="margin: 148px 0 0 14px;">
        </figure>
    </div>
</section>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-11 col-sm-12">
                <div class="visible-on-mobile">
                    <div class="image-max-height" style="background-image: url(images/girl.png);"></div>
                </div>
                ...
                <div class="row m-b-30">
                    ...
                    <div class="col-md-4 col-sm-4 visible-on-wade visible-on-tablet">
                        <div class="image-max-height"
                             style="background-image: url(images/girl.png);background-size: cover;background-position-x: -52px;"></div>
                    </div>
                    <div class="col-md-4 col-sm-4">
            ...
            <div class="col-md-12">
                ...
                <div class="row m-b-30">
                    <div class="col-md-4 col-sm-12">
                        <div class="count-all interlayer" style="background-image: url(images/icon/icon_41.svg);">
                            <div class="count-loan-number">285</div>
                            <div class="count-loan-text">число займов за сегодня</div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-12">
                        <div class="count-all interlayer" style="background-image: url(images/icon/icon_42.svg);">
                    ...
                    <div class="col-md-4 col-sm-12">
                        <div class="m-b-30">
                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#">Подать
                                заявку
                            </button>
                        </div>
                    </div>
                ...
                <div class="owl-carousel owl-theme questions-block-2">
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    В автоломбарде под залог ПТС можно быстро получить деньги. Нужно зайти на главную
                                    страницу и оставить там заявку. Потом следует передать данные специалисту по
                                    телефону и дождаться решения. Процедура занимает не больше 20 минут.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    Автоломбард залог ПТС в Ставрополе предлагает клиентам получить кредит на карту или
                                    наличными. Для получения денег следует посетить офис и подписать там договор. Можно
                                    оформить заявку в онлайн режиме, тогда придется предоставить данные банковской
                                    карты.
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    Автоломбард под залог автомобиля будет забирать только ПТС. Машина останется у
                                    владельца, чтобы он ею пользовался. Разрешается передвигаться на транспортном
                                    средстве по России и можно не переживать о том, что авто заберут сотрудники МФО.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    Получить кредит в круглосуточном автоломбарде под залог ПТС можно не только по
                                    генеральной доверенности от хозяина машины, но и по ДКП. В документе должно быть
                                    написано право залога и передоверия.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    Для получения займа нужны определенные документы: ПТС, СТС и паспорт владельца
                                    машины. Чтобы взять автозалог в Ставрополе человеку должно быть 18 лет. Принимаются
                                    любые автомобили в хорошем состоянии. Самое главное, чтобы авто было на ходу.
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-12 col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Обратилась в автоломбард, под залог ПТС в Ставрополе взяла
                                    кредит. Заявку быстро одобрили, процесс занял не больше часа. Справку о доходе не
                                    спрашивали, кредитную историю не смотрели. Это очень удобно.
                                </div>
                            ...
                            <article class="review-bg-grey">
                                <div class="review-text">Ломбард под залог ПТС авто мне выдал 150 000 рублей. Эту сумму
                                    я выплачивал год. Ставку не повышали, никаких проблем не возникала. Доволен
                                    сотрудничеством, так как оно оказалось взаимовыгодным.
                                </div>
                                <div class="review-person">
                        ...
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Понравилось то, что работает автоломбард круглосуточно. Мне
                                    срочно потребовались деньги ночью. Обратился в эту организацию, подал документы, и
                                    сумма оказалась на моей карте уже через 40 минут.
                                </div>
                                <div class="review-person">
                            ...
                            <article class="review-bg-grey">
                                <div class="review-text">Брала кредит в автоломбарде, условия под залог ПТС устроили.
                                    Очереди не было, заявку одобрили за 30 минут. Я получила наличные, и уже через три
                                    месяца вернула долг. Буду ещё обращаться, спасибо!
                                </div>
                                <div class="review-person">
                        ...
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Порадовала скорость обработки заявки, низкая ставка,
                                    внимательность сотрудников. Ломбард автомобилей под залог ПТС мне выдал 500 000
                                    рублей на два года. Очень рад, что обратился в эту организацию. В банке мне бы не
                                    одобрили кредит.
                                </div>
                                <div class="review-person">
                ...
                <div class="visible-on-mobile">
                    <div class="owl-carousel owl-theme reviews-4">
                        <article class="review-bg-grey">
                            <div class="review-text">Обратилась в автоломбард, под залог ПТС в Ставрополе взяла кредит.
                                Заявку быстро одобрили, процесс занял не больше часа. Справку о доходе не спрашивали,
                                кредитную историю не смотрели. Это очень удобно.
                            </div>
                            <div class="review-person">
                                <div class="review-name">Марина</div>
                            </div>
                        ...
                        <article class="review-bg-grey">
                            <div class="review-text">Ломбард под залог ПТС авто мне выдал 150 000 рублей. Эту сумму я
                                выплачивал год. Ставку не повышали, никаких проблем не возникала. Доволен
                                сотрудничеством, так как оно оказалось взаимовыгодным.
                            </div>
                            <div class="review-person">
                                <div class="review-name">Олег</div>
                        ...
                        <article class="review-bg-grey">
                            <div class="review-text">Понравилось то, что работает автоломбард круглосуточно. Мне срочно
                                потребовались деньги ночью. Обратился в эту организацию, подал документы, и сумма
                                оказалась на моей карте уже через 40 минут.
                            </div>
                            <div class="review-person">
                                <div class="review-name">Валентин</div>
                            </div>
                        ...
                        <article class="review-bg-grey">
                            <div class="review-text">Порадовала скорость обработки заявки, низкая ставка, внимательность
                                сотрудников. Ломбард автомобилей под залог ПТС мне выдал 500 000 рублей на два года.
                                Очень рад, что обратился в эту организацию. В банке мне бы не одобрили кредит.
                            </div>
                            <div class="review-person">
                                <div class="review-name">Дмитрий</div>
                            </div>
...
<section id="section-map">
    <div class="container">
        <div class="row">
            <div class="col-md-12 col-sm-12">
                <h3 class="h1 " style="color:#BC6D4C ">Адреса и <span class="yellow-text">контакты</span></h3>

                <div id="map" class="ofices visible-on-wade visible-on-tablet" itemscope
                     itemtype="http://schema.org/PostalAddress">
                    <form class="map_filter visible-on-wade visible-on-tablet" action="#">
                        <div id="addresses" class="mapOptions__addresses white">
                            <div class="map-text">
                ...
                <div class="visible-on-mobile" itemscope itemtype="http://schema.org/PostalAddress">
                    <div class="region_address">
                        <div class="row all_address">
                            <div class="col-md-12">
                                <div class="address-contac t">
                                    <span itemprop="postalCode"
                                          class="addresses-text-bold">346880, г. Батайск</span><br>
                                    <span itemprop="streetAddress"
                                          class="addresses-text-bold">ул. М.Горького, 285Г</span><br>
                                    режим работы: 9:00-19:00
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="col-md-5">
                <div class="col-md-12">
                    <div class="footer-logo inline "><a href="#"><img style="width: 100px"
                                                                      ...
                                                                      alt="Автоломбард под залог ПТС  в Ставрополе"/></a>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <ul class="footer-li bold">
                            ...
                            <li><a href="pod-gruzovie-avtomobili.php">Грузовые авто</a></li>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <ul class="footer-li bold">
                            <li><a href="pod-moto.php">Мототехника</a></li>
                            <li><a href="dlja-biznesa.php">Юр. Лица</a></li>
                            <li><a href="zaim-pod-pts.html">Займ</a></li>
                        </ul>
                    </div>
            ...
            <div class="col-md-12">
                <div class="footer-bottom">
                    <p>«Автозайм Ставрополь» не является финансовым учреждением, банком или МФО. Сайт предоставляет
