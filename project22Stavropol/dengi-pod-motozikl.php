...
<div title="взять кредит в залог автомобиля в Ставрополе" class="bgImageAvto">
  ...
  </span><span class="yellow-text">мототехники  в Ставрополе</span></h1>
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="product-template-bg grey">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="element-img"
                                             style="background-image: url(images/product/skuter.jpg);"></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="product-right">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="product-template-bg grey">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="element-img"
                                             style="background-image: url(images/product/chooper1.jpg);"></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="product-right">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="product-template-bg grey">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="element-img"
                                             style="background-image: url(images/product/motorbike2.jpg); background-size: contain"></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="product-right">
...
<section id="interlayer-2">
    <div class="container">
        ...
        <figure class="get-image-interlayer visible-on-wade visible-on-tablet"><img src="images/product/mot2.png"
                                                                                    alt="motocikl"
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-11 col-sm-12">
                ...
                <h3 class="h1"><span class="h1-span">Требования для получения </span>займа под ПТС в Ростове-на-Дону
                </h3>
                ...
                <div class="owl-carousel owl-theme example-loan">
                    <div class="example-car right">
                        <div class="example-car-img"
                             style="background-image: url(images/product/mot1.png);    background-size: 286px;"></div>
            ...
            <div class="col-md-11 col-sm-12">
                ...
                <div class="owl-carousel owl-theme questions-block-2">
                    <div class="question-answer">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="question">Могу ли я вернуть деньги за свой мотоцикл раньше установленного
                                    срока?
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    Можно досрочно погасить задолженность в любой момент. Никаких комиссий и штрафов не
                                    будет взиматься. Если решил взять залог под ПТС мотоцикла, он сможет вернуть
                                    денежные средства раньше установленного срока без пени.
                    ...
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    Можно в любое время суток взять кредит под залог ПТС мотоцикла, компания не будет
                                    переоформлять ТС на себя. Мы только кредитуем, поэтому не надо об этом волноваться.
                                    Мотоцикл будет оформлен на владельца, но придется оставить в залог ПТС.
                    ...
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    Можно взять займ под залог ПТС мотоцикла на срок от 1 до 5 лет. Потребуется
                                    предоставить только 3 документа для оформления кредита. Деньги выдаются всем людям,
                                    у которых в собственности мотоцикл. Погасить задолженность можно всегда в любой
                                    момент без штрафов.
            ...
            <div class="col-md-12 col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Банк мне не давал займ под залог под ПТС мотоцикла. Решил
                                    обратиться в автоломбард и не пожалел. Оформление кредита оказалось простым. Деньги
                                    выдали в тот же день. Долг выплатил вовремя, штрафов мне не насчитали.

                                </div>
                                <div class="review-person">
                                    <div class="review-name">Григорий</div>
                                </div>
                            </article>
                        ...
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Возникли финансовые проблемы. Пришлось брать кредит под залог
                                    ПТС мотоцикла. Хорошо, что эта компания сразу одобрила заявку. Не знаю, что и делал
                                    бы. Деньги получил через час. Вернул их за два месяца, ПТС сразу отдали.
                        ...
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Уже второй раз оформляю займ под залог ПТС мотоцикла.
                                    Оказалось, что это быстро и легко. Мотоцикл осмотрел эксперт, высоко его оценил. Без
                                    проблем выдали 200 000 рублей на год. Порадовало то, что деньги быстро получил.
                ...
                <div class="visible-on-mobile">
                    <div class="owl-carousel owl-theme reviews-4">
                        ...
                        <article class="review-bg-grey">
                            <div class="review-text">Возникли финансовые проблемы. Пришлось брать кредит под залог ПТС
                                мотоцикла. Хорошо, что эта компания сразу одобрила заявку. Не знаю, что и делал бы.
                                Деньги получил через час. Вернул их за два месяца, ПТС сразу отдали.
                        ...
                        <article class="review-bg-grey">
                            <div class="review-text">Уже второй раз оформляю займ под залог ПТС мотоцикла. Оказалось,
                                что это быстро и легко. Мотоцикл осмотрел эксперт, высоко его оценил. Без проблем выдали
                                200 000 рублей на год. Порадовало то, что деньги быстро получил.
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <ul class="footer-li bold">
                            ...
                            <li><a href="dengi-dlja-biznesa-pod-pts-avto.php">Юр. Лица</a></li>
