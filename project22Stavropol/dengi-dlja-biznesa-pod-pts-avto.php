...
<head>
    ...
    <title>Автоломбард под залог ПТС в Ставрополе для Юр. Лиц</title>
...
<div title="взять кредит в залог автомобиля в Ставрополе" class="bgImageAvto">
  ...
  </span><span class="yellow-text"> Юр. Лиц в Ставрополе</span></h1>
            ...
            <div class="col-md-11 col-sm-12">
                ...
                <div class="owl-carousel owl-theme questions-block-2">
                    <div class="question-answer">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="question">Можно ли оформить кредит под ПТС авто, воспользовавшись
                                    генеральной доверенностью?
                                </div>
                            </div>
                            <div class="col-md-8">
                                <div class="answer">
                                    Если интересует залог ПТС для юридических лиц, то нужно уточнить вопрос по поводу
                                    использования генеральной доверенности. Оформить кредит возможно только в том
                                    случае, если хозяин машины передал доверенному лицу максимальные полномочия
                    ...
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    Кредит для юридических лиц под залог авто выдается только в том случае, если
                                    предоставить все документы. Нужно будет прислать паспорт РФ, ПТС и СТС. Можно
                                    обращаться в компанию с плохой кредитной историей, так как на это специалисты не
                                    смотрят.
                    ...
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    Кредит юр. лицам под залог автомобиля выдается на срок от 1 года до 5 лет. Можно
                                    будет не только поэтапно погашать задолженность, но и досрочно. Если человек
                                    откажется отдавать деньги, кредитор имеет право взыскать заложенный автомобиль.
            ...
            <div class="col-md-12 col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Меня интересовал кредит в залог ПТС для юридических лиц. Этот
                                    автоломбард выдал 500 000 рублей на год. Кредит оформили за час, хотя банк отказал.
                                    Рад, что нашёл эту компанию.

                                </div>
                                <div class="review-person">
                                    <div class="review-name">Глеб</div>
                                </div>
                            </article>
                        ...
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Пришлось брать кредит под залог ПТС для развития бизнеса. В
                                    автоломбарде работают грамотные сотрудники. Они охотно отвечают на все вопросы,
                                    помогают разобраться в ситуации. Я сотрудничеством осталась довольна.
                        ...
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Нужно было взять кредит для ИП под залог автомобиля. Выбрал эту
                                    компанию и не пожалел. Пришлось предъявить минимум документов. Ставка оказалась
                                    низкой, мне всё понравилось. Планирую ещё обращаться.
                                </div>
                                <div class="review-person">
                ...
                <div class="visible-on-mobile">
                    <div class="owl-carousel owl-theme reviews-4">
                        <article class="review-bg-grey">
                            <div class="review-text">Меня интересовал кредит в залог ПТС для юридических лиц. Этот
                                автоломбард выдал 500 000 рублей на год. Кредит оформили за час, хотя банк отказал. Рад,
                                что нашёл эту компанию.
                        ...
                        <article class="review-bg-grey">
                            <div class="review-text">Пришлось брать кредит под залог ПТС для развития бизнеса. В
                                автоломбарде работают грамотные сотрудники. Они охотно отвечают на все вопросы, помогают
                                разобраться в ситуации. Я сотрудничеством осталась довольна.
                        ...
                        <article class="review-bg-grey">
                            <div class="review-text">Нужно было взять кредит для ИП под залог автомобиля. Выбрал эту
                                компанию и не пожалел. Пришлось предъявить минимум документов. Ставка оказалась низкой,
                                мне всё понравилось. Планирую ещё обращаться.
