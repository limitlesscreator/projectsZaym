...
<div title="взять кредит в залог автомобиля в Ставрополе" class="bgImageAvto">
  ...
  </span><span class="yellow-text">  спецтехники в Ставрополе</span></h1>
            ...
            <div class="col-md-12 col-sm-12">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="product-template-bg grey">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="element-img"
                                             style="background-image: url(images/product/kran.jpg);"></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="product-right">
                ...
                <div class="visible-on-mobile">
                    <div class="owl-carousel owl-theme product">
                        ...
                        <div class="product-template-bg grey">
                            <div class="element-img"
                                 style="background-image: url(images/product/pogruzchik.png);"></div>
                            <div class="product-right">
                                <div class="element-title">Погрузчики</div>
                                <div class="element-text">Вилочные ковшовые</div>
                                <div class="element-wrap"><a href="#" class="btn btn-danger">Оценить</a></div>
                        ...
                        <div class="product-template-bg grey">
                            <div class="element-img" style="background-image: url(images/product/kran.jpg);"></div>
                            <div class="product-right">
                                <div class="element-title">Краны</div>
                                <div class="element-text">Авто, башенные</div>
                                <div class="element-wrap"><a href="#" class="btn btn-danger">Оценить</a></div>
...
<section id="interlayer-2">
    <div class="container">
        ...
        <figure class="get-image-interlayer visible-on-wade visible-on-tablet"><img src="images/product/tracktor11.png"
                                                                                    alt="tracktor"
                                                                                    style="margin: 148px 0 0 14px; width: 400px;">
        </figure>
    </div>
</section>
                ...
                <div class="owl-carousel owl-theme example-loan">
                    <div class="example-car right">
                        <div class="example-car-img"
                             style="background-image: url(images/product/tracktor33.png);"></div>
                ...
                <div class="owl-carousel owl-theme questions-block-2">
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    МФО предлагает всем клиентам получить займ под залог спецтехники. Потребуется только
                                    оставить заявку на сайте компании и дождаться звонка менеджера. Потом следует
                                    приехать в офис, чтобы забрать наличные.
                    ...
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    Компания выдает деньги круглосуточно под ПТС любой спецтехнике. МФО сможет взять
                                    катки, погрузчики, краны, бульдозеры и тракторы. Кредит под залог ПТС спецтехники
                                    оформляется в течение 1 часа. Транспортное средство остается у владельца, поэтому
                                    его можно использовать для работы.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    Автоломбард спецтехники под залог ПТС в Ставрополе предлагает взять кредит в любое
                                    время суток. Компания работает круглосуточно, поэтому оставить заявку можно не
                                    только днем, но и ночью. Деньги удастся получить в течение 25-40 минут.
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-12 col-sm-12">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Часто беру займ под залог ПТС спецтехники в Ставрополе.
                                    Обращаюсь только в этот автоломбард. Условия выгодные, стоимость авто не занижают.
                                    ТС быстро осматривают. Мне всё нравится, ещё и ставка невысокая.
                        ...
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Первый раз брал займ под спецтехнику. Выбрал эту организацию,
                                    так как показалась надёжной. Отзывы о ней хорошие. Мою заявку сразу одобрили, деньги
                                    выдали. Долг уже успел вернуть, ничего лишнего не насчитали.
                        ...
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Рассматривал разные компании, где дают залог под ПТС
                                    спецтехники. Выбрал именно эту по нескольким причинам. Во-первых, она мне показалась
                                    честной. Во-вторых, заявку сразу одобрили и выдали деньги. Компания работает
                                    оперативно!
                ...
                <div class="visible-on-mobile">
                    <div class="owl-carousel owl-theme reviews-4">
                        <article class="review-bg-grey">
                            <div class="review-text">Часто беру займ под залог ПТС спецтехники в Ставрополе. Обращаюсь
                                только в этот автоломбард. Условия выгодные, стоимость авто не занижают. ТС быстро
                                осматривают. Мне всё нравится, ещё и ставка невысокая.
                        ...
                        <article class="review-bg-grey">
                            <div class="review-text">Первый раз брал займ под спецтехнику. Выбрал эту организацию, так
                                как показалась надёжной. Отзывы о ней хорошие. Мою заявку сразу одобрили, деньги выдали.
                                Долг уже успел вернуть, ничего лишнего не насчитали.
                        ...
                        <article class="review-bg-grey">
                            <div class="review-text">Рассматривал разные компании, где дают залог под ПТС спецтехники.
                                Выбрал именно эту по нескольким причинам. Во-первых, она мне показалась честной.
                                Во-вторых, заявку сразу одобрили и выдали деньги. Компания работает оперативно!
