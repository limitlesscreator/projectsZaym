...
<div title="взять кредит в залог автомобиля в Ставрополе" class="bgImageAvto">
  ...
  </span><span class="yellow-text">грузовых авто в Ставрополе</span></h1>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="product-template-bg grey">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="element-img" style="background-image: url(images/product/truck3.jpg);background-size: contain;"></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="product-right">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="product-template-bg grey">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="element-img" style="background-image: url(images/product/tyagach.jpg);"></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="product-right">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="product-template-bg grey">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="element-img" style="background-image: url(images/product/pricep.jpg);"></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="product-right">
...
<section id="interlayer-2">
    <div class="container">
        ...
        <figure class="get-image-interlayer visible-on-wade visible-on-tablet"><img src="images/product/bluetruck.png"
                                                                                    alt="truck"
                ...
                <div class="owl-carousel owl-theme example-loan">
                    <div class="example-car right">
                        <div class="example-car-img"
                             style="background-image: url(images/product/truck.png); width: 376px;"></div>
                ...
                <div class="owl-carousel owl-theme questions-block-2">
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    Да, можно вернуть задолженность за транспортное средство раньше условленного срока. Не придется платить пени. Деньги под залог грузового автомобиля нужно обязательно возвращать, иначе придется столкнуться с серьезными проблемами.
                    ...
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    Нет, МФО занимается только кредитованием, поэтому транспортное средство не будет переоформляться на нашу компанию. Мы берет только в залог ПТС грузовика. Транспортным средством клиент имеет право пользоваться.
                    ...
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">
                                    МФО принимает грузовые автомобили, которые находятся в хорошем и исправном состоянии. Отечественным транспортным средствам должно быть до 10 лет, а импортным до 20 лет. Нужно будет оставить только в залог ПТС грузовика. Транспортным средством можно продолжать пользоваться.
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Привлекла эта компания, так как она выдаёт займ под залог ПТС в Ставрополе круглосуточно. Я подала заявку поздно вечером, мне сразу ответили. Специалисты быстро оформили займ и перечислили деньги на карту.
                            ...
                            <article class="review-bg-grey">
                                <div class="review-text">Не хотел брать автозайм под ПТС, но пришлось. В целом всё прошло успешно. Справку о доходах не нужно было предоставлять. Брать кредит оказалось легко, никакой возни. На мои вопросы ответили, деньги сразу выдали. Всё понравилось.
                        ...
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Если хотите взять быстрый займ под залог ПТС, обращайтесь в эту компанию. Я сам пользуюсь её услугами. Заявки всегда одобряют, деньги быстро выдают. Всё отлично. Главное, вовремя погашать задолженность, и проблем не будет.
                            ...
                            <article class="review-bg-grey">
                                <div class="review-text">Здесь можно взять займы онлайн под залог ПТС на карту. Мне одобрили заявку дистанционно. Даже ехать никуда не пришлось. Деньги сразу перечислили на карту. Долг уже вернула, и могу сказать, что компания честно работает.
                        ...
                        <div class="col-md-4">
                            <article class="review-bg-grey">
                                <div class="review-text">Решил в автоломбарде взять займ под залог ПТС. Никаких очередей не было, ждать долго не пришлось. Оформление кредита заняло всего полчаса. Деньги выдали наличными, это очень удобно.
                                </div>
                                <div class="review-person">
