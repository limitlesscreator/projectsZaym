            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="offer-bg-incline bg-1">
                        <div class="z-index">
                            <h1 class="h1"><span class="h1-span">Займ под залог ПТС  </span>спецтехники <?=$in_city ?></h1>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="product-template-bg grey">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="element-img" style="background-image: url(images/product/tractor5.jpg);"></div>
                                        </div>
                                        <div class="col-md-6">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="product-template-bg grey">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="element-img" style="background-image: url(images/product/pogruzchik2.jpg);"></div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="product-right">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="product-template-bg grey">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="element-img" style="background-image: url(images/product/buldozer2.jpg);"></div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="product-right">
        ...
        <div class="row">
            <div class="col-md-4 col-sm-12">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-6">
                        <img class="m-t-image" src="images/p4298/tractor4.png" alt="Автоломбард под залог ПТС"/>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-11 col-sm-12">
                ...
                <div class="owl-carousel owl-theme questions-block-2">
                    <div class="question-answer">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="question">Можно ли получить займ под залог ПТС спецтехники?</div>
                            </div>
                            <div class="col-md-8">
                                <div class="answer">Если вам срочно нужна достаточно солидная сумма денег, обращайтесь к нам. Мы выдаем займ под залог спецтехники. В качестве залога у нас остаются только документы на спецтехнику. Вы продолжаете ею пользоваться. Важно лишь вернуть деньги в срок.
</div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="question">Какую спецтехнику вы принимаете в залог?</div>
                            </div>
                            <div class="col-md-8">
                                <div class="answer">Если вы хотите взять кредит под залог ПТС спецтехники, нет ничего проще. Мы принимаем погрузчики, катки, бульдозеры, тракторы, экскаваторы и краны. В качестве залога у нас остается только ПТС на спецтехнику. Вы продолжите ею пользоваться в прежнем режиме. </div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="question">Как быстро я получу деньги под залог ПТС спецтехники? </div>
                            </div>
                            <div class="col-md-8">
                                <div class="answer">Если вы хотите срочно решить финансовые проблемы, обращайтесь в наш автоломбард спецтехники, чтобы получить деньги под залог ПТС в москве. Мы выдаем необходимую сумму в течение 20 – 40 минут. Работаем 24 часа в сутки, 7 дней в неделю. Оставлять заявки можно круглосуточно. </div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="owl-carousel owl-theme reviews-2">
                        <article class="review-bg-blue">
                            <div class="review-text">У меня плохая кредитная история, поэтому даже не обращался в банк. Решил у этой компании взять займ под залог спецтехники. Заявку мне одобрили и быстро перевели деньги на карту. Компания честно работает.</div>
                            <div class="review-person">
                                <div class="review-name">Глеб</div>
                            </div>
                        </article>
                        <article class="review-bg-blue">
                            <div class="review-text">Друг посоветовал в этом автоломбарде взять займ под спецтехнику. Условия выдачи денег выгодные. Наличные я получил в тот же день. Я быстро погасил задолженность, всего за 3 месяца и мне вернули ПТС за мой погрузчик.</div>
                            <div class="review-person">
                                <div class="review-name">Георгий </div>
                            </div>
                        </article>
                        <article class="review-bg-blue">
                            <div class="review-text">Пришёл в офис автоломбарда, уже через полчаса мне выдали деньги под залог ПТС спецтехники. Сотрудники вежливые, охотно отвечают на вопросы. Я не пожалел, что обратился именно в эту компанию.</div>
                            <div class="review-person">
                                <div class="review-name">Леонид</div>
                            </div>
                        </article>
                        <article class="review-bg-blue">
                            <div class="review-text">Не все компании выдают кредит под залог ПТС спецтехники. Мне только этот автоломбард одобрил заявку. ТС посмотрели вживую, ни к чему не придрались. В тот же день выдали 120 тысяч рублей в долг.</div>
                            <div class="review-person">
                                <div class="review-name">Семён </div>
                            </div>
                        </article>
                        <article class="review-bg-blue">
                            <div class="review-text">Если нужно взять быстрый займ под залог спецтехники, я обращаюсь только в этот ломбард. Процедура оформления и выдачи кредита занимает не больше часа. Мне заявку всегда одобряют, деньги выдают без лишних вопросов.</div>
                            <div class="review-person">
