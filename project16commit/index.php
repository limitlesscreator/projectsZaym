            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="offer-bg-incline bg-1">
                        <div class="z-index">
                            <h1 class="h1"><span class="h1-span">Займ под залог ПТС  </span> <?=$in_city ?></h1>
            ...
            <div class="col-md-12 col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="element-img"
                                             style="background-image: url(images/p4298/sedan5.png);"></div>
                                    </div>
                                    <div class="col-md-6">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="product-template-bg grey">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="element-img"
                                             style="background-image: url(images/p4298/truck5.png);"></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="product-right">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="product-template-bg grey">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="element-img"
                                             style="background-image: url(images/p4298/tractor5.png);"></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="product-right">
                        ...
                        <div class="col-md-6 col-sm-6">
                            <div class="product-template-bg grey">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="element-img"
                                             style="background-image: url(images/p4298/motorbike5.png); background-size: contain"></div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="product-right">
                ...
                <div class="visible-on-mobile">
                    <div class="owl-carousel owl-theme product">
                        <div class="product-template-bg grey">
                            <div class="element-img" style="background-image: url(images/p4298/sedan5.png);"></div>
                            <div class="product-right">
                                <div class="element-title">Легковые авто</div>
                                <div class="element-text">Отечественные авто, иномарки</div>
                        ...
                        <div class="product-template-bg grey">
                            <div class="element-img" style="background-image: url(images/p4298/truck5.png);"></div>
                            <div class="product-right">
                                <div class="element-title">Грузовые авто</div>
                                <div class="element-text">Газели, тягачи, фуры</div>
                                <div class="element-wrap"><a href="#" class="btn btn-danger">Оценить</a></div>
                        ...
                        <div class="product-template-bg grey">
                            <div class="element-img" style="background-image: url(images/p4298/tractor5.png);"></div>
                            <div class="product-right">
                                <div class="element-title">Спецтехника</div>
                                <div class="element-text">Трактора, бульдозеры, погрузчики, краны</div>
                                <div class="element-wrap"><a href="#" class="btn btn-danger">Оценить</a></div>
                        ...
                        <div class="product-template-bg grey">
                            <div class="element-img" style="background-image: url(images/p4298/motorbike5.png);"></div>
                            <div class="product-right">
                                <div class="element-title">Мототехника</div>
                                <div class="element-text">Мотоциклы, квадроциклы, скутеры</div>
                                <div class="element-wrap"><a href="#" class="btn btn-danger">Оценить</a></div>
            ...
            <div class="col-md-11 col-sm-12">
                ...
                <div class="owl-carousel owl-theme questions-block-2">
                    <div class="question-answer">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="question">Как получить займ под залог ПТС в автоломбарде? </div>
                            </div>
                            <div class="col-md-8">
                                <div class="answer">Получить займ под залог ПТС в Москве очень просто и максимально удобно. Для этого необходимо действовать поэтапно:
                                                    оставить заявку на сайте;
                                                    позвонить по телефону нашему менеджеру для того, чтобы передать данные;
                                                    ждать решения.
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">Получить займ под залог ПТС в Москве просто. Выдача денег производится наличными или же на карту. Каждый сам выбирает для себя тот вариант, который ему подходит. Есть возможность решить финансовые проблемы просто и быстро. </div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">Для этого стоит использовать займ под залог ПТС авто в Москве. При этом можно не беспокоиться, что у вас заберут автомобиль. Машина остается у вас. Мы забираем только ПТС. Важно лишь вернуть взятую в залог сумму вовремя. </div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">Да. Вы можете взять в нашем автоломбарде займ по разным документам: по ДКП и генеральной доверенности. Такая возможность есть не только у собственников. Лучшее решение всех возникших финансовых проблем – это машина в залог в Москве. </div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">Получить займ под залог ПТС в Москве чрезвычайно просто и быстро. Для этого необходимо лишь предоставить ПТС и СТС транспортного средства. В качестве залога у нас остается только ПТС. Вы продолжите ездить на своём автомобиле. </div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="owl-carousel owl-theme reviews-2">
                        <article class="review-bg-blue">
                            <div class="review-text">Часто беру в этом автоломбарде наличные под залог ПТС. Никакие дополнительные документы предоставлять не надо. Нравится то, что быстро оформляют заявку и сразу выдают деньги. Лишних вопросов не задают.</div>
                            <div class="review-person">
                                <div class="review-name">Вадим </div>
                            </div>
                        </article>
                        <article class="review-bg-blue">
                            <div class="review-text">Три месяца назад решил взять деньги под залог ПТС в этом автоломбарде. Не пожалел. Долг уже отдал, никаких лишних процентов не насчитали. Процентная ставка низкая, заявку сразу одобряют. Буду ещё обращаться.</div>
                            <div class="review-person">
                                <div class="review-name">Валентин</div>
                            </div>
                        </article>
                        <article class="review-bg-blue">
                            <div class="review-text">Мне понравилось то, что в этом автоломбарде можно взять деньги под залог ПТС круглосуточно в Москве. Я ночью обратился в эту компанию, и уже через час на руках была нужная сумма. Не пришлось ждать, пока откроются банки.</div>
                            <div class="review-person">
                                <div class="review-name">Михаил</div>
                            </div>
                        </article>
                        <article class="review-bg-blue">
                            <div class="review-text">Я оформляла займ под залог ПТС онлайн. Уже через 10 минут после подачи заявки мне перезвонил сотрудник компании. Заявку одобрили, деньги перевели на банковскую карту. Долг уже погасила, проблем не возникло.</div>
                            <div class="review-person">
                                <div class="review-name">Алёна</div>
                            </div>
                        </article>
                        <article class="review-bg-blue">
                            <div class="review-text">Обратилась в этот автоломбард в Москве. Под залог ПТС взяла 100 тысяч рублей. У меня плохая кредитная история, но деньги быстро выдали. Очень понравилось то, насколько оперативно работает компания.</div>
                            <div class="review-person">
