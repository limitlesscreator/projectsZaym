                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                <div class="product-template-bg grey">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="element-img" style="background-image: url(images/product/gazel2.png);"></div>
                                        </div>
                                        <div class="col-md-6">
            ...
            <div class="col-md-11 col-sm-12">
                ...
                <div class="owl-carousel owl-theme questions-block-2">
                    <div class="question-answer">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="question">Могу ли я возвратить долг за грузовой автомобиль раньше условленного срока?</div>
                            </div>
                            <div class="col-md-8">
                                <div class="answer">Если вы брали в нашем автоломбарде деньги под залог грузового автомобиля, вернуть взятую сумму можно раньше прописанного в документах срока. При этом никаких пени за досрочный возврат не начисляется.</div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">Если вы оформите займ под залог ПТС грузовика, он не будет переоформляться на нашу компанию. Мы просто выдаем кредиты под залог документов на грузовой транспорт. Автомобиль останется у вас. Деньги можно вернуть досрочно или в обговоренный срок. </div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="question">Важен ли возраст грузового автомобиля в процессе кредитования.</div>
                            </div>
                            <div class="col-md-8">
                                <div class="answer">Вы можете оформить залог под ПТС грузовика на автомобили определенного возраста. Для отечественных он составляет максимум 10 лет, для импортных – максимум 20 лет. В качестве залога мы забираем лишь ПТС. Автомобиль остается при вас. </div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="owl-carousel owl-theme reviews-2">
                        <article class="review-bg-blue">
                            <div class="review-text">Брал у этой конторы под залог грузового автомобиля 500 тысяч рублей. Мне помогли оформить заявку и объяснили, как погашать долг. За 4 месяца деньги вернул и уже забрал ПТС.</div>
                            <div class="review-person">
                                <div class="review-name">Дмитрий </div>
                            </div>
                        </article>
                        <article class="review-bg-blue">
                            <div class="review-text">Долго искал, где дадут деньги под залог ПТС грузового автомобиля. Выбрал эту компанию, о ней хорошие отзывы. До сих пор не пожалел. Долг почти погасил, никаких лишних выплат мне не насчитывали и не штрафовали.</div>
                            <div class="review-person">
                                <div class="review-name">Андрей</div>
                            </div>
                        </article>
                        <article class="review-bg-blue">
                            <div class="review-text">Эта компания даёт крупные суммы в залог грузовых авто. Я брал 800 тыс. руб., так как хотел открыть бизнес. Условия выгодные, мне понравилось то, что процентная ставка низкая. Пока ещё отдаю долг.</div>
                            <div class="review-person">
                                <div class="review-name">Степан К.</div>
                            </div>
                        </article>
                        <article class="review-bg-blue">
                            <div class="review-text">Решил взять займ под залог грузового автомобиля, чтобы сделать ремонт. Оставил заявку на сайте, мне быстро перезвонили. После осмотра грузовика подтвердили выдачу денег. В тот же день я получил наличные под ПТС авто.</div>
                            <div class="review-person">
                                <div class="review-name">Валентин </div>
                            </div>
                        </article>
                        <article class="review-bg-blue">
                            <div class="review-text">В эту компанию обращаюсь уже третий раз. Опять брал займ под грузовой автомобиль, точнее под его ПТС. Если долг вовремя погашать, никаких проблем не возникает. Компания работает честно. Я в другие автоломбарды даже не думаю обращаться.</div>
                            <div class="review-person">
