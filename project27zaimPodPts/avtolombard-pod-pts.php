                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="offer-bg-incline bg-2">
                            <div class="z-Index">
                                <h1 class="h1 padding-leftOnPc3">Автоломбард под ПТС <?= $in_city ?></h1>
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="owl-carousel owl-theme reviews-1">
                    <article class="review-bg-no">
                        <div class="review-text">Сейчас условия в автоломбардах совсем не хуже, чем в МФО или крупных банках. Недавно мне
                                                 тоже пришлось оформить займ, оставив в ломбарде документы на машину. Деньги пришли на
                                                 банковскую карту к вечеру. Удобно, что можно погасить долг намного быстрее, чем указано в
                                                 договоре.</div>
                    ...
                    <article class="review-bg-no">
                        <div class="review-text">Взять займ в автоломбарде под ПТС машины занимает не больше двух часов. Вы подаете заявку
                                                 на сайте или в офисе компании, ждете одобрения и после положительного ответа оформляете
                                                 договор, получаете деньги наличными или переводом на карту онлайн. Я рекомендую этот способ
                                                 кредитования всем, кому действительно срочно понадобились деньги!</div>
                        <div class="review-person">
                            <div class="review-name">Иван</div>
                        </div>
                    </article>
                    <article class="review-bg-no">
                        <div class="review-text">Пришлось обратиться в круглосуточный автоломбард под ПТС в Ейске, когда у меня на улице
                                                 украли сумку со всеми деньгами. Единственное, что спасло – это наличие всех документов в
                                                 отеле. Я отдала паспорт и ПТС на машину в автоломбарде, рассказала все девушке, которая
                                                 работала в вечернюю смену. Займ мне одобрили, и уже на следующий день деньги я получила на
                                                 руки. И наконец-таки смогла уехать домой.</div>
                        <div class="review-person">
                            <div class="review-name">Светлана С.</div>
                        </div>
                    </article>
                </div>
            </div>
...
<script type="text/babel">
    let data = [
        [{question: 'Информация о полученных займах попадает в мою кредитную историю?'},
            {answer: `Автоломбард при выдаче займа под залог ПТС не учитывает кредитную
                      историю. При получении кредита учитывается только состояние транспортного
                      средства. Автоломбард не подает заявку в бюро кредитных историй.`},
            {numId: '0'},
            {numIdText: 'Zero'}],

        [{question: 'Можно погасить займ, находясь в другом городе?'},
            {answer: `Да. На сайте автоломбарда есть функция онлайн погашения кредита. Вы
                      сможете выплатить займ из любого города. Для этого свяжитесь с нашим
                      менеджером. Автоломбард выдает займы под ПТС автомобиля без привязки к
                      местоположению заявителя.`},
            {numId: '1'},
            {numIdText: 'One'}],

        [{question: 'У вас есть скрытые комиссии и проценты? Какова полная стоимость займа?'},
            {answer: `Автоломбард предоставляет выгодные условия кредитования. Скрытые
                      комиссии и пени не начисляются, в том числе при выплате займа раньше
                      установленного срока. Полная стоимость кредитования зависит от условий
                      заявителя и состояния транспортного средства. Точную сумму можно узнать
                      после подачи заявки.`},
            {numId: '2'},
            {numIdText: 'Two'}],
    ]
