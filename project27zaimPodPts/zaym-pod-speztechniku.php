                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="offer-bg-incline bg-2">
                            <div class="z-Index">
                                <h1 class="h1 padding-leftOnPc3">Займ под ПТС
                                                                 спецтехники <?= $in_city ?></h1>
                ...
                <div class="col-md-12 col-sm-12">
                    ...
                    <div class="visible-on-wade visible-on-tablet">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-sm-6 col-xs-12">
                                <div class="product-template-bg">
                                    <div title="кредит под залог грузового автомобиля в банке" class="element-img grey" style="background-image: url(images/product/pogruzchik2.png);"></div>
                    ...
                    <div class="visible-on-mobile">
                        <div class="owl-carousel owl-theme product">
                            ...
                            <div class="product-template-bg">
                                <div class="element-img grey" style="background-image: url(images/product/pogruzchik2.png);"></div>
                                <div class="element-title">Погрузчики</div>
                                <div class="element-text">Вилочные ковшовые</div>
        ...
        <div class="row">
            <div class="col-md-3 col-sm-4">
                <div class="image-max-height"
                     style="background-image: url(images/tractorVer.jpg); background-size: cover; background-repeat: no-repeat"></div>
            </div>
            ...
            <div class="row">
                <div class="col-md-5 col-sm-12">
                    <div class="bg-grey-man">
                        ...
                        <img src="images/product/tracktor22.png" alt="Займы под ПТС в Ейске"/>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-12">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-6">
                        <img class="m-t-image" src="images/product/buldozer.jpg"
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="owl-carousel owl-theme reviews-1">
                    <article class="review-bg-no">
                        <div class="review-text">Я был приятно удивлен, когда узнал, что можно взять деньги под залог ПТС спецтехники. Сейчас в
                                                 кризис плохо с выплатами по зарплате, бывают задержки. В целом приходится искать, где найти
                                                 деньги. Хоть мы в семье и стараемся экономить, делать какие-то сбережения. Но вот сейчас не
                                                 получилось. И я обратился в местный автоломбард. Думал, оставлю под залог свой погрузчик
                                                 Хендай. Менеджер посоветовал отдать документы на спецтехнику. И да, у меня есть такая
                                                 возможность. Короче, обязательно сходите узнать все о возможностях оформления займов в
                                                 автоломбарде. Настоятельно вам рекомендую!</div>
                        <div class="review-person">
                            <div class="review-name">Иван</div>
                        </div>
                    </article>
                    <article class="review-bg-no">
                        <div class="review-text">В этом автоломбарде можно взять деньги под залог ПТС спецтехники в Ейске. Никогда бы об этом
                                                 не подумал, но тут коллега посоветовал, зная о моих сложностях с финансами. Оформил займ
                                                 прямо онлайн, не выходя из дома. Быстрое одобрение заявки, техника остается у меня, а
                                                 руководство компании получает лишь документы. Процент по займу небольшой – как и в банке
                                                 сейчас.</div>
                        <div class="review-person">
                    ...
                    <article class="review-bg-no">
                        <div class="review-text">Если вам срочно нужны деньги, то советую обратится в автоломбард под залог ПТС спецтехники.
                                                 То есть вы оставляете документы на оборудование, или на грузовое авто, личный транспорт – и
                                                 получаете на руки деньги с необходимостью погашения всей суммы в течение нескольких

                                                 месяцев или года. Я действительно советую этот способ кредитования, поскольку он очень
                                                 простой и с минимальной вероятностью отказа.</div>
                        <div class="review-person">
                            <div class="review-name">Сергей</div>
                        </div>
                    </article>
                    <article class="review-bg-no">
                        <div class="review-text">Обратится в автоломбард для оформления займа под залог спецтехники меня надоумила жена.
                                                 Ей кто-то рассказал об этом на работе. Ну я и решил попробовать, особо не надеясь на одобрение.
                                                 В офисе меня проконсультировали по процентной ставке, и изучив всю информацию – я подал
                                                 заявку. Мне одобрили сумму в 100 тысяч рублей на срок до года. Это было лучшее решение за
                                                 последнее время. Всем советую!</div>
                        <div class="review-person">
                            <div class="review-name">Егор</div>
                        </div>
                    </article>
                    <article class="review-bg-no">
                        <div class="review-text">Взять займ под залог спецтехники теперь можно и в Ейске. У нас появился отличный автоломбард,
                                                 который принимает не только личное и грузовое авто, но и спецтехнику. У меня в собственности
                                                 для решения рабочих задач как раз-таки есть бульдозер. Посоветовавшись со своим
                                                 руководством, я решил взять займ. Мы используем его для продвижения бизнеса.</div>
                        <div class="review-person">
...
<script type="text/babel">
    let data = [
        [{question: 'Можно ли получить займ под спецтехнику?'},
            {answer: `Да. Автоломбард выдает займы под спецтехнику. В заявке на получение займа
                      необходимо указать тип спецтехники и характеристики. Для оформления
                      понадобится ПТС, СТС и Ваш паспорт. При выдаче учитывается состояние
                      спецтехники, дата выпуска и технические характеристики.`},
            {numId: '0'},
            {numIdText: 'Zero'}],

        [{question: 'Какую спецтехнику вы принимаете в залог?'},
            {answer: `Займ под залог ПТС на спецтехнику выдается на тракторы, бульдозеры, катки,
                      погрузчики и краны. При подаче заявки укажите тип спецтехники. Условия
                      займа будут зависеть от категории оборудования, его состояния и возраста.`},
            {numId: '1'},
            {numIdText: 'One'}],

        [{question: 'Как быстро я получу деньги под залог ПТС?'},
            {answer: `Займ под спецтехнику выдается в течение 20-40 минут после обращения в
                      автоломбард. Мы работаем круглосуточно, без выходных и праздников. Вы
                      можете оставить заявку в любое время. Менеджер свяжется с Вами для
                      уточнения информации в ближайшее время.`},
            {numId: '2'},
            {numIdText: 'Two'}],
    ]
    ReactDOM.render(
