                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="offer-bg-incline bg-2">
                            <div class="z-Index">
                                <h1 class="h1 padding-leftOnPc3">Займы под залог
                                    ПТС <?= $in_city ?></h1>
        ...
        <div class="row">
            <div class="col-md-3 col-sm-4">
                <div class="image-max-height"
                     style="background-image: url(images/forProject27/Audi-Audi-Sport-Quattro-S1-Group-B-sports-car-audi-quattro-red-cars-1970763-wallhere.com.jpg); background-size: cover; background-repeat: no-repeat"></div>
            </div>
            ...
            <div class="row">
                <div class="col-md-5 col-sm-12">
                    <div class="bg-grey-man">
                        ...
                        <img src="images/forProject27/car_side_front.png" alt="Займы под ПТС в Ейске"/>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-12">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-6">
                        <img class="m-t-image" src="images/forProject27/car_second_side.png"
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="owl-carousel owl-theme reviews-1">
                    <article class="review-bg-no">
                        <div class="review-text">Я доверяю только проверенным компаниям, особенно если речь идет о займе под залог ПТС
                            онлайн. Этот автоломбард мне посоветовал друг. Он тоже недавно оказался в сложной
                            финансовой ситуации, и пришлось заложить автомобиль. Ответ по заявке пришел в течение 20
                            минут. Договор был составлен верно, без лишних, неточных фраз. Деньги забрал на следующий
                            день. Всем рекомендую этот автоломбард!</div>
                        <div class="review-person">
                            <div class="review-name">Дмитрий</div>
                        </div>
                    </article>
                    <article class="review-bg-no">
                        <div class="review-text">Уже не первый раз сталкиваюсь с проблемой, где взять деньги под залог ПТС. Сейчас в Москве и
                            других крупных городах много МФО, но в Ейске все не так просто. Поэтому решил обратиться в
                            автоломбард. Договор составили подробно после долгой консультации с руководством компании.
                            Меня все устроило, и я отдал документы на автомобиль даже без раздумий. Простой и надежный
                            способ получить деньги быстро.</div>
                        <div class="review-person">
                            <div class="review-name">Кристиан</div>
                        </div>
                    </article>
                    <article class="review-bg-no">
                        <div class="review-text">Оформить быстрый займ под залог ПТС теперь можно онлайн. Я не первый раз пользуюсь этим
                            способом, и знаю, что это намного лучше, чем МФО или кредиты в банке. Вы берете деньги в долг
                            под проценты, а в обмен оставляете документы на автомобиль. Не волнуйтесь с вашим
                            транспортным средством ничего не случится!</div>
                        <div class="review-person">
                            <div class="review-name">Полина</div>
                        </div>
                    </article>
                    <article class="review-bg-no">
                        <div class="review-text">Автоломбард работает круглосуточно и бех выходных, и я с радостью воспользовалась
                            возможностью оформления займа под залог ПТС. Вообще все можно сделать за считанные
                            минуты онлайн. Оставляете заявку, ждете одобрения, передаете документы на автомобиль,
                            получаете деньги на банковскую карту.</div>
                        <div class="review-person">
                            <div class="review-name">Анастасия</div>
                        </div>
                    </article>
                    <article class="review-bg-no">
                        <div class="review-text">Короче, я нашел отличный способ взять деньги в долг под небольшой процент. Обращайтесь в
                            автоломбард, если, конечно, у вас есть собственный автомобиль (или можно по доверенности).
                            Взять займ под залог ПТС в Ейске проще простого. Можно оформить кредит онлайн на их
                            официальном сайте или в офисе компании. Особенно хочу отметить, что сотрудники не спешат
                            уговорить вас на займ, а подробно объясняют все плюсы и минусы.</div>
                        <div class="review-person">
                            <div class="review-name">Сергей П.</div>
                        </div>
                    </article>
                </div>
            </div>
...
<script type="text/babel">
    let data = [
        [{question: `Как получить займ под ПТС в автоломбарде?`},
            {answer: `Займ под залог ПТС выдается в три простых этапа. Необходимо оставить заявку
на сайте — это первый этап. Далее, когда менеджер свяжется с Вами по
телефону, передайте необходимые сведения. На третьем и последнем этапе Вам
придет ответ на заявку.`},
            {numId: '0'},
            {numIdText: 'Zero'}],

        [{question: `Займ выдается наличными или на карту?`},
            {answer: `Займ под залог ПТС авто выдается наличными деньгами или перечислением на
банковскую карту. Способ получения указывается в заявке. Если Вы выбрали
перевод на банковскую карту, менеджер уточнит реквизиты для отправки
денежных средств.`},
            {numId: '1'},
            {numIdText: 'One'}],

        [{question: `Автомобиль остается у вас?`},
            {answer: `Мы берем под залог только ПТС. Транспортное средство остается у Вас. Деньги
под залог ПТС в Ейске выдаются после предоставления документа. Автомобиль
только осмотрят для оценки его состояния и выявления повреждений. Вы
можете пользоваться транспортным средством в течение всего срока займа.`},
            {numId: '2'},
            {numIdText: 'Two'}],

        [{question: `Можно ли взять кредит в автоломбарде по генеральной доверенности?`},
            {answer: `Да. Займ под ПТС авто могут получить не только владельцы транспортного
средства, но и доверенные лица. Вы можете воспользоваться услугой по
генеральной доверенности или договору купли-продажи автомобиля.
Информацию об этом необходимо уточнить при подаче заявки или менеджеру
по телефону.`},
            {numId: '3'},
            {numIdText: 'Three'}],

        [{question: `Что нужно для получения кредита под ПТС?`},
            {answer: `Займ под залог ПТС автомобиля выдается на основе трех документов: ПТС,
СТС и паспорт человека, на который оформляется займ. Автоломбард забирает
только ПТС. СТС и паспорт остаются у Вас, как и автомобиль. Информацию
для оформления займа необходимо передать менеджеру по телефону.`},
            {numId: '4'},
            {numIdText: 'Four'}],
    ]
    ReactDOM.render(
