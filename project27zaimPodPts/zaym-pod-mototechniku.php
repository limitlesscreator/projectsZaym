        ...
        <div class="row">
            <div class="col-md-3 col-sm-4">
                <div class="image-max-height"
                     style="background-image: url(images/verMotorBike.jpg); background-size: cover; background-repeat: no-repeat"></div>
            </div>
            ...
            <div class="row">
                <div class="col-md-5 col-sm-12">
                    <div class="bg-grey-man">
                        ...
                        <img src="images/p4298/audi_14.png" alt="Займы под ПТС в Ейске"/>
                    </div>
                </div>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-12">
                <div class="row">
                    ...
                    <div class="col-md-12 col-sm-6">
                        <img class="m-t-image" src="images/p4298/mop.png"
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="owl-carousel owl-theme reviews-1">
                    <article class="review-bg-no">
                        <div class="review-text">Вы думаете, где взять деньги под залог ПТС мототехники, так обращайтесь в данный автоломбард
                                                 в Ейске. Здесь адекватные сотрудники, которые всегда готовы помочь. Обработка заявок в
                                                 течение 10-15 минут, минимальная вероятность отказа и низкая процентная ставка. Также у вас
                                                 есть возможность досрочного погашения займа. Я рекомендую кредитование в автоломбардах
                                                 всем друзьям и знакомым!</div>
                        <div class="review-person">
                            <div class="review-name">Егор</div>
                        </div>
                    </article>
                    <article class="review-bg-no">
                        <div class="review-text">Не знаете, где взять деньги, если у вас плохая кредитная история? Я недавно пришел в
                                                 автоломбард и получил займ под залог ПТС мототехники. Мне было совсем не жалко свой старый
                                                 мотоцикл, который и так давно пылился в гараже. Оформление всех документов занимает не
                                                 более 1 часа. Деньги можно получить наличными или переводом на банковскую карту.</div>
                        <div class="review-person">
                            <div class="review-name">Антон Калинин</div>
                        </div>
                    </article>
                    <article class="review-bg-no">
                        <div class="review-text">Эта компания покорила меня своей щепетильностью в проверке документов. Все было сделано
                                                 очень точно, и в то же время быстро. Всем советую брать деньги под залог ПТС мототехники, как
                                                 это сделал я в прошлом месяце!</div>
                        <div class="review-person">
                            <div class="review-name">Дмитрий</div>
                        </div>
                    </article>
                    <article class="review-bg-no">
                        <div class="review-text">В этом автоломбарде принимают не только новые машины, но и грузовое авто, транспортные
                                                 средства отечественного производства, спецтехнику и мотоциклы. Мне срочно понадобились
                                                 деньги, и вот уже сейчас на моем банковскому счету 150 тысяч рублей. Займ под залог
                                                 мототехники в автоломбарде помог мне решить финансовые проблемы. Планирую погасить долг
                                                 в течение 3 месяцев, и сэкономить на процентах!</div>
                        <div class="review-person">
                            <div class="review-name">Никита</div>
                        </div>
                    </article>
                    <article class="review-bg-no">
                        <div class="review-text">Хочу вам рассказать об отличном способе взять деньги в долг! Недавно я оформил займ под
                                                 залог мототехники в Ейске. Этот автоломбард надежный, это я вам могу гарантировать. Низкая
                                                 процентная ставка, быстрая обработка заявок онлайн и в офисе.</div>
                        <div class="review-person">
...
<script type="text/babel">
    let data = [
        [{question: `Могу ли я вернуть деньги за свой мотоцикл раньше условленного срока?`},
            {answer: `Да. Автоломбард выдает займ под залог ПТС мотоцикла на срок,
                      установленный после оценки транспортного средства. Вы можете выплатить
                      кредит раньше этого периода. При этом не начисляются дополнительные пени
                      или комиссии. Вы получите ПТС после выплаты всего займа.`},
            {numId: '0'},
            {numIdText: 'Zero'}],

        [{question: `Можете ли вы переоформить мой мотоцикл на ваш автоломбард?`},
            {answer: `Автоломбард только выдает займы под залог ПТС мотоцикла. Все остальные
                      документы остаются у Вас на руках. Мы не переоформляем транспортные
                      средства на автоломбард. Вы можете пользоваться мотоциклом в течение всего
                      периода займа.`},
            {numId: '1'},
            {numIdText: 'One'}],

        [{question: `На какой срок можно получить займ под залог мототехники?`},
            {answer: `Займ под ПТС мототехники выдается на срок от 1 года до 5 лет. При подаче
                      заявки укажите желаемый период кредитования. После оценки состояния
                      мототехники автоломбард примет решение о максимальном возможном сроке
                      займа.`},
            {numId: '2'},
            {numIdText: 'Two'}],
    ]
