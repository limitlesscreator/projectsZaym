                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="offer-bg-incline bg-2">
                            <div class="z-Index">
                                <h1 class="h1 padding-leftOnPc3">Кредит под ПТС
                                    <?= $in_city ?></h1>
            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="owl-carousel owl-theme reviews-1">
                    <article class="review-bg-no">
                        <div class="review-text">Прямо сейчас вы можете взять кредит под залог автомобиля с нормальной процентной ставкой.
                                                 Месяц назад я пришел в местный ломбард, чтобы узнать подробности. Менеджер мне все
                                                 детально рассказала, и в тот же вечер я подал заявку онлайн. Утром пришло подтверждение, и
                                                 уже к обеду на моем счету было 500 тысяч рублей. Это простой и надежный способ взять деньги в
                                                 долг. Всем рекомендую!</div>
                        <div class="review-person">
                            <div class="review-name">Артем</div>
                        </div>
                    </article>
                    <article class="review-bg-no">
                        <div class="review-text">В автоломбарде не смотрят на вашу кредитную историю, и не откажут, если были просрочки по
                                                 ипотеке. Надо срочно оформить кредит под ПТС автомобиля в Ейске – пожалуйста, все будет
                                                 сделано в кратчайшие сроки. Я настоятельно рекомендую вам этот способ кредитования. 30
                                                 минут, и деньги уже на вашей кредитной карте.</div>
                        <div class="review-person">
                            <div class="review-name">Сергей</div>
                        </div>
                    </article>
                    <article class="review-bg-no">
                        <div class="review-text">Две недели назад мне впервые пришлось воспользоваться услугами автоломбардов. Взять кредит
                                                 под залог авто в автоломбарде оказалось очень просто. Низкая процентная ставка, обработка
                                                 заявки онлайн за 10-15 минут и высокий % одобрений. У меня испорченная кредитная история, и
                                                 этот способ был единственно верным для меня.</div>
                        <div class="review-person">
                            <div class="review-name">Елизавета</div>
                        </div>
                    </article>
                    <article class="review-bg-no">
                        <div class="review-text">Получить кредит в автоломбарде под залог ПТС у меня заняло всего 1 день. Хотя до этого я месяц
                                                 пыталась получить кредит на 500 тысяч рублей в банках и МФО. Никогда раньше не оформляла
                                                 займы и не брала деньги в долг, но возникла проблема, которую нужно было срочно решить. Но
                                                 вот в банке даже надежным клиентам оформить займ сейчас - это похоже проблема.</div>
                        <div class="review-person">
                            <div class="review-name">Мария</div>
                        </div>
                    </article>
                    <article class="review-bg-no">
                        <div class="review-text">Оформить кредит в автоломбарде сейчас просто. Вы оставляете в качестве залога ПТС
                                                 автомобиля, и получаете деньги на банковскую карту. У меня этот процесс занял всего полдня.
                                                 Большое спасибо за финансовую поддержку!</div>
                        <div class="review-person">
...
<script type="text/babel">
    let data = [
        [{question: `Можно ли получить кредит под ПТС, воспользовавшись генеральной
                     доверенностью?`},
            {answer: `Да. Можно получить кредит в залог ПТС в Ейске по доверенности. В документе
                      должны быть указаны максимальные полномочия по распоряжению
                      транспортным средством (имуществом владельца).`},
            {numId: '0'},
            {numIdText: 'Zero'}],

        [{question: `Как заложить ПТС без отказа и с низким процентом по доверенности?`},
            {answer: `Кредит в залог ПТС автомобиля в Ейске выдается на основе паспорта
                      гражданина РФ и свидетельства о прохождении регистрации (СТС).
                      Автоломбард забирает только ПТС на срок кредитования или пока займ не
                      будет выплачен.`},
            {numId: '1'},
            {numIdText: 'One'}],

        [{question: `На какой срок я могу оформить кредит под ПТС?`},
            {answer: `Кредит наличными под ПТС выдается на период от 1 года до 5 лет. Точный
                      срок кредитования уточняется при рассмотрении заявки и после предоставления
                      точных сведений. Автоломбард принимает решение о периоде займа. При
                      желании Вы можете выбрать меньший срок.`},
            {numId: '2'},
            {numIdText: 'Two'}],
    ]
    ReactDOM.render(
