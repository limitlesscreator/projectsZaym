            ...
            <div class="col-md-12 col-sm-12">
                ...
                <div class="owl-carousel owl-theme reviews-1">
                    <article class="review-bg-no">
                        <div class="review-text">Не знаете, где взять деньги на развитие бизнеса – тогда обратитесь в автоломбард под залог ПТС
                                                 для юр. лиц. Я раньше и не знал, что такие финансовые организации работают с компаниями и
                                                 ИП. Оказалось, что для юр. лиц процентная ставка ниже, и практически нет ограничений по сумме
                                                 и выплатам займа.</div>
                        <div class="review-person">
                            <div class="review-name">Денис</div>
                        </div>
                    </article>
                    <article class="review-bg-no">
                        <div class="review-text">Заложить машину в ломбарде для развития бизнеса? Знаю, что это звучит очень глупо. Но в
                                                 современной действительности взять в банке миллион рублей на продвижение почти
                                                 невозможно. В этом ломбарде я получил ДС без особых проблем.</div>
                        <div class="review-person">
                            <div class="review-name">Дмитрий</div>
                        </div>
                    </article>
                    <article class="review-bg-no">
                        <div class="review-text">Недавно мне срочно понадобились деньги на лекарства и продукты для родных. Срочно
                                                 понадобилось взять кредит или оформить займ, но я даже не знала, как это делается. Поэтому по
                                                 совету друга обратилась в круглосуточный автоломбард в Ейске для юридических лиц. Спросите
                                                 почему выбрала услуги для компаний? А потому, что я давно зарегистрирована, как ИП, и у меня
                                                 небольшой магазин женской одежды в центре города.</div>
                        <div class="review-person">
...
<script type="text/babel">
    let data = [
        [{question: `На какой срок выдают кредит под залог авто для юридических лиц и ИП?`},
            {answer: `Займ под ПТС юридическим лицам выдается на срок от 1 года до 5 лет. Период
                      кредитования рассчитывается в индивидуальном порядке с учетом состояния
                      транспортного средства. Вы можете указать желаемый срок займа в заявке,
                      автоломбард учтет это при принятии решения о кредитовании.`},
            {numId: '0'},
            {numIdText: 'Zero'}],

        [{question: `Учитывается ли кредитная история при получении займа под залог ПТС для юр.
                     лиц?`},
            {answer: `Нет. Займ под залог ПТС авто юр. лицам выдается без учета кредитной истории.
                      Автоломбарду важно состояние транспортного средства и паспорт на него.
                      Кредитная история юридического лица или ИП не влияет на условия
                      кредитования.`},
            {numId: '1'},
            {numIdText: 'One'}],

        [{question: `Какие требования к авто для получения займа юр. лицам?`},
            {answer: `Деньги под залог ПТС юр. лицу выдаются после осмотра транспортного
                      средства. Автомобиль должен быть в исправном состоянии без значительных
                      повреждений. Максимальный возраст отечественного транспорта составляет 10
                      лет, для иностранных моделей — 20 лет.`},
            {numId: '2'},
            {numIdText: 'Two'}],
    ]
    ReactDOM.render(
