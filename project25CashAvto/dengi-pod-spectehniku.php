                           ...
                           <div class="row">
                               <div class="col-md-6 col-sm-6">
                                   <div class="product-template-bg grey">
                                       <div class="row">
                                           <div class="col-md-6">
                                               <div class="element-img" style="background-image: url(images/product/tractor4.png);"></div>
                                           </div>
                                           <div class="col-md-6">
                ...
                <div class="owl-carousel owl-theme reviews-3">
                    <article class="review-bg-red-border">
                        <div class="red-border">
                            <div class="review-text">Тяжело найти нормальную фирму, выдающую займ под залог ПТС спецтехники в Москве. Но мне удалось, и вам я тоже советую этих ребят. Процедура быстрая, тратктор оставил себе, часть денег верну с её помощью.</div>
                        </div>
                    ...
                    <article class="review-bg-red-border">
                        <div class="red-border">
                            <div class="review-text">Порадовало, что выдают займ под спецтехнику без её изъятия. Она кормит мою семью, поэтому хорошо, что её оставили. Буду дальше работать на погрузчике, возвращать кредит. </div>
                        </div>
                        <div class="review-person">
                    ...
                    <article class="review-bg-red-border">
                        <div class="red-border">
                            <div class="review-text">Можно сказать, что я у них постоянный клиент. Уже третий раз беру займ в залог спецтехники под ПТС. Если выплачивать вовремя, то процент будет небольшой. Возиться со сбором документов не надо, поэтому рекомендую.
</div>
                        </div>
                        <div class="review-person">
