                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="offer-bg-incline bg-2">
                            <div class="z-Index">
                                <h1 class="h1 padding-leftOnPc3">Автоломбард под
                                                                 залог ПТС <?= $in_city ?></h1>
                ...
                <div class="owl-carousel owl-theme questions-block-1">
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">Оформление займа происходит в три этапа:
                                                    Через форму на сайте вы оставляете заявку на кредит;
                                                    Сообщаете сотруднику ломбарда регистрационные данные машины и сведения, подтверждающие вашу личность;
                                                    Получаете деньги под залог ПТС в Москве.</div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">Для удобства наших клиентов мы предусмотрели возможность дистанционного оформления кредита по запросу заемщика. В нашем автоломбарде вы можете оформить займ под залог ПТС онлайн, не приезжая в офис компании, что значительно ускоряет процедуру получения денег.
</div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="question">Я купил автомобиль, но пока не оформил его в ГИБДД. Ваш автоломбард выдает займы без регистрации транспортного средства?
</div>
                            </div>
                            <div class="col-md-8">
                                <div class="answer">Условия займов под залог ПТС в нашем автоломбарде позволяют получить деньги тем, кто еще не зарегистрировал автомобиль. Для этого нужно предоставить договор купли-продажи машины либо доверенность от предыдущего собственника с правом распоряжения его транспортом.
</div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="owl-carousel owl-theme reviews-3">
                    <article class="review-bg-red-border">
                        <div class="red-border">
                            <div class="review-text">В этом автоломбарде условия под залог ПТС выгоднее, чем в других местах. Во-первых, машина остаётся у хозяина, во-вторых, деньги могут выдать в день обращения удобным способом, в-третьих, менеджеры ничего не скрывают и подсказывают.
</div>
                        </div>
                        <div class="review-person">
                            <div class="review-name">Рустам</div>
                        </div>
                    </article>
                    <article class="review-bg-red-border">
                        <div class="red-border">
                            <div class="review-text">Автоломбард под залог ПТС в Москве второй раз предлагает более низкие проценты, чем в первый. Хорошо, что упрощают условия для постоянных клиентов. В сложный период эта мелочь может сильно помочь.
</div>
                        </div>
                        <div class="review-person">
                            <div class="review-name">Армен</div>
                        </div>
                    </article>
                    <article class="review-bg-red-border">
                        <div class="red-border">
                            <div class="review-text">В 2021 году нужны были деньги, чтобы спасти свой бизнес. Клиент посоветовал ломбард под залог ПТС авто. Изучил условия выдачи, ничего плохого не нашёл, доверился. Расплатился достаточно быстро, поэтому особо не переплатил.
</div>
                        </div>
                        <div class="review-person">
                    ...
                    <article class="review-bg-red-border">
                        <div class="red-border">
                            <div class="review-text">Если понадобился ломбард автомобилей под залог, то обращайтесь в эту компанию. Кто ещё знает фирму в нашем городе, где так мало требований, адекватные проценты и выдача денег на следующий день?
</div>
                        </div>
                        <div class="review-person">
                    ...
                    <article class="review-bg-red-border">
                        <div class="red-border">
                            <div class="review-text">Деньги могут потребоваться в любое время, как у меня и произошло. Поэтому хорошо, что автоломбард круглосуточно работает. Вся процедура прошла оперативно, нареканий нет. </div>
                        </div>
                        <div class="review-person">
