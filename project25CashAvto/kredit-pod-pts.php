                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="offer-bg-incline bg-2">
                            <div class="z-Index">
                                <h1 class="h1 padding-leftOnPc3">Кредиты под залог
                                                                     ПТС <?= $in_city ?></h1>
            ...
            <div class="col-md-11 col-sm-12">
                ...
                <div class="owl-carousel owl-theme questions-block-1">
                    <div class="question-answer">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="question">На какой срок выдают кредит под залог автомобиля для юридических лиц?</div>
                            </div>
                            <div class="col-md-8">
                                <div class="answer">У нас вы можете взять кредит под залог машины, не лишаясь ее: в ломбард вы передаете только ПТС, а сам автомобиль остается в вашем пользовании.
                                                    Для юридических лиц мы предусмотрели возможность заключения договора на длительный срок (до пяти лет).
</div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">В отличие от банков, автоломбард не проверяет вашу кредитную историю. У нас предприниматели и компании могут получить кредит, оставив в залог ПТС, даже если раньше у них имелись просрочки по кредитам или их кредитная нагрузка превышает установленные ЦБ лимиты.
</div>
                            </div>
                        </div>
                    </div>
                    <div class="question-answer">
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="answer">Чтобы вы могли взять кредит по залог машины в Москве в нашем ломбарде, ваш автомобиль должен соответствовать следующим требованиям:
                                                    исправное техническое состояние;
                                                    возраст не старше 10 лет – для отечественных авто;
                                                    возраст не старше 20 лет – для машин импортного производства.
</div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="owl-carousel owl-theme reviews-3">
                    <article class="review-bg-red-border">
                        <div class="red-border">
                            <div class="review-text">Полгода назад понадобились деньги на операцию, поэтому взял в этом автоломбарде кредит в залог ПТС машины. Займы - всегда плохо, но ситуации бывают разные. Здесь условия нормальные, можно без проблем выплачивать проценты.
</div>
                        </div>
                    ...
                    <article class="review-bg-red-border">
                        <div class="red-border">
                            <div class="review-text">Решил второй раз у них взять кредит под залог авто в Москве. Мне даже немного снизили ставку. Приятно. Не нужно возиться с документами, с момента заявки до выдачи денег прошло меньше суток.
</div>
                        </div>
                        <div class="review-person">
                    ...
                    <article class="review-bg-red-border">
                        <div class="red-border">
                            <div class="review-text">Если понадобились срочно деньги, и у вас есть только квартира или машина, то берите кредит в залог автомобиля. Авто остаётся у вас. Денег за автомобиль дали больше, чем я рассчитывала. Выплачиваю долг без задержек, поэтому особо не переплачиваю.</div>
                        </div>
                        <div class="review-person">
