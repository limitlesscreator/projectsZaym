                          ...
                          <div class="row">
                              <div class="col-md-6 col-sm-6">
                                  <div class="product-template-bg grey">
                                      <div class="row">
                                          <div class="col-md-6">
                                              <div class="element-img" style="background-image: url(images/product/gazel3.png);"></div>
                                          </div>
                                          <div class="col-md-6">
                              ...
                              <div class="col-md-6 col-sm-6">
                                  <div class="product-template-bg grey">
                                      <div class="row">
                                          <div class="col-md-6">
                                              <div class="element-img" style="background-image: url(images/product/pricep1.png);"></div>
                                          </div>
                                          <div class="col-md-6">
                                              <div class="product-right">
...
Не так много компаний, которые выдают деньги под залог ПТС грузового автомобиля. Тут послушал совет друга, изучил условия, которые компания предлагает. Оно того стоит. В других конторах переплата вышла бы больше.
</div>
                        </div>
                    ...
                    <article class="review-bg-red-border">
                        <div class="red-border">
                            <div class="review-text">Понадобились срочно деньги, а кроме грузовика заложить нечего. Безработный, поэтому банки не выдают нормальный кредит. Ситуация сложная. Но этот ломбард выдаёт их под залог под ПТС грузового автомобиля. Спасибо, выручили!</div>
                        </div>
                        <div class="review-person">
                    ...
                    <article class="review-bg-red-border">
                        <div class="red-border">
                            <div class="review-text">Компанией, которая выдаёт деньги под залог грузовых авто в Москве, доволен. Очень общительные девушки, всё объяснили, рассказали, какие условия для меня выгоднее.
</div>
                        </div>
                        <div class="review-person">
