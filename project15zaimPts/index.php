...
<header class="header header-transparent header-main header-white">
    <div class="header-top">
        <div class="container">
            ...
            <div class="extra-nav">
                <ul>
                    <li class="icon-phone"><a href="tel:000000000000"><span class="icon-item-span"></span></a></li>
                    <li>
                        ...
                        <figure class="col-lg-12 d-lg-block position-absolute top-0 right-0 pr-0 ie-main-hero">
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 1137.5 979.2"
                                ...
                                <g transform="matrix(1 0 0 1 0 0)" clip-path="url(#mainHeroSVG2)">
                                    <image width="750" height="750" xlink:href="images/woman-car-salon_750.jpg"
                ...
                <div class="visible-on-wade visible-on-tablet">
                    <div class="row">
                        <div class="col-md-2 col-sm-4">
                            <div class="list-icon-grey-item">
                                <div class="list-icon-grey-item-img"
                                     style="background-image: url(images/icon/icon_23.png); background-size: 50px 50px"></div>
                        ...
                        <div class="col-md-2 col-sm-4">
                            <div class="list-icon-grey-item">
                                <div class="list-icon-grey-item-img"
                                     style="background-image: url(images/icon/icon_24.png); background-size: 50px 50px"></div>
                        ...
                        <div class="col-md-2 col-sm-4">
                            <div class="list-icon-grey-item">
                                <div class="list-icon-grey-item-img"
                                     style="background-image: url(images/icon/icon_25.png); background-size: 50px 50px"></div>
                        ...
                        <div class="col-md-2 col-sm-4">
                            <div class="list-icon-grey-item">
                                <div class="list-icon-grey-item-img"
                                     style="background-image: url(images/icon/icon_26.png); background-size: 50px 50px"></div>
                        ...
                        <div class="col-md-2 col-sm-4">
                            <div class="list-icon-grey-item">
                                <div class="list-icon-grey-item-img"
                                     style="background-image: url(images/icon/icon_27.png); background-size: 50px 50px"></div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <div class="sset"><img src="images/icon/viber.svg" alt="Автоломбард под залог ПТС"/>
                                        <a href="#">Viber</a></div>
                                </div>
                            </div>
                        </div>
                ...
                <div id="map" class="ofices visible-on-wade visible-on-tablet">
                    <form class="map_filter visible-on-wade visible-on-tablet" action="#">
                        <div id="addresses" class="mapOptions__addresses gradient" itemScope
                            ...
                            <div class="map-text">
                                <a href="tel:+00000000">0 (000) 000-00-00</a><br>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                ...
                <div class="footer-phone m-b-30"><a href="tel:+78002226500">0 (000) 000-00-00</a><br></div>
                ...
                <div class="row">
                    <div class="col-md-4 col-sm-6">
                        <ul class="footer-li bold">
                            <li><a href="#">Займ под авто</a></li>
                            <li><a href="#">Займ под ПТС</a></li>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <ul class="footer-li bold">
                            ...
                            <li><a href="#">Кредит на покупку авто</a></li>
                        </ul>
                    </div>
                    <div class="col-md-4">
                        <ul class="footer-li bold">
                            <li><a href="#questionAnswer">Вопросы и ответы</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="col-md-12 m-b-30 ">
                <hr>
                <button type="button" class="btn btn-danger footer-btn" data-toggle="modal" data-target="#CallPhone-ver-4">Оформить
                    займ
                </button>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <ul class="off-canvas-li">
                            <li><a href="avtozaem-pod-pts.php">Кредит под ПТС</a></li>
                            <li><a href="avtozaem-pod-gruzovogoi-avtomobil.php">Грузовые авто</a></li>
                            <li><a href="avtozaem-pod-spectehniku.php">Спецтехника</a></li>
                            <li><a href="kredit-yuridicheskim-licam.php">Юр. лицам</a></li>
                            <li><a href="avtozaem-pod-pts-moto.php">Мототехника</a></li>
